...
<!-- PMD_GLOBAL_CONTENT_RAIL_V1_START -->
<style id="pmd-global-content-rail-v1">

  /*
   * ONE outer horizontal rail for every page that renders Side Menu 2.
   *
   * Desktop:
   * menu right + 14px
   *
  ...
  body .page-content {
    ...
    padding-left: var(--pmd-admin-gap, 14px) !important;
    padding-right: var(--pmd-admin-gap, 14px) !important;
  }

  /*
   * Structural Bootstrap/admin wrappers must not add a SECOND outer rail.
   * Their internal rows/grid gutters remain untouched.
   */
  html.pmd-side-menu2-global-page
  ...
  /*
   * Settings previously owned their own 16px root rail.
   * The shell owns the rail now, exactly like Shifts.
   */
  html.pmd-side-menu2-global-page
  body.pmd-settings-suite :is(
    #pmd-settings-center,
...
<!-- PMD_GLOBAL_CONTENT_RAIL_V1_END -->
