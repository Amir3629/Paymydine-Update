...
class PmdTrustedLoginDeviceService
{
    ...
    {
        // PMD_TRUST_READY_TRACE_TEMP_20260831
        try {
            $database = null;
            ...
            try {
                ...
                $database = 'DB_NAME_ERROR: '.$databaseError->getMessage();
            }

            $hasTable = Schema::hasTable('pmd_site_access_devices');
            ...
            logger()->warning('PMD TRUST READY TRACE', [
                'database' => $database,
                'has_table' => $hasTable,
                'has_user_id' => $hasUserId,
            ]);

            return $hasTable && $hasUserId;
        } catch (\Throwable $error) {
            logger()->error('PMD TRUST READY TRACE exception', [
