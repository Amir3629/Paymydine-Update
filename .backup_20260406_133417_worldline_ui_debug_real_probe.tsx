...
export function WorldlineInlineCardForm({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const expiryMasked = expiryDigits.length >= 4 ? `${expiryDigits.slice(0, 2)}/${expiryDigits.slice(2, 4)}` : expiryDigits
      ...
      const safeSet = (fieldId: string, value: string) => {
        ...
        try {
          ...
          result.errors.push("request.setValue: " + String(e?.message || e))
        }
      ...
      const setResults = {
        ...
        securityCode: safeSet("securityCode", rawCvv),
      ...
      const fieldValidation = {
        ...
        securityCode: safeValidateField("securityCode"),
      ...
      try {
        ...
        validationResult = { threw: true, message: String(e?.message || e) }
      }
      ...
      const rawCardNumber = String(formData.cardNumber ?? "")
