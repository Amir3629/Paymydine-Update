...
{
    public function testAdminChatIsTenantLocalUserAndLocationScoped(): void
    {
        ...
        self::assertStringContainsString("['location_id', 'admin_user_id', 'id']", $migration);
    }
    ...
    public function testAdminPageIsOneFocusedChatWorkspace(): void
    {
        $root = dirname(__DIR__, 2);
        ...
        self::assertStringContainsString('<details class="pmd-ai-safety-details">', $view);
