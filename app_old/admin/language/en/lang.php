...
return [
    ...
    'orders' => [
        ...
        'text_note_history' => 'Note History',
    ...
    'permissions' => [
        ...
        'pos_devices' => 'Manage pos devices',
        'pos_configs' => 'Create, edit and delete pos',
    ],
    ...
    'settings' => [
        ...
        'text_after_save_heading' => 'After Saving',
        'text_after_save_description' => 'Use the dropdown to choose whether you continue editing, go back to the listing or create a new record after saving.',
        'text_after_save_dropdown_title' => 'After saving',
        'text_toggle_dropdown' => 'Toggle Dropdown',
    ],
    ...
    'pos_devices' => [
        'text_title' => 'POS Devices',
        'text_form_name' => 'POS Devices',
        'text_empty' => 'There are no POS Devices available.'
    ],

    'pos_configs' => [
        'text_title' => 'POS',
        'text_form_name' => 'Pos',
        'text_filter_search' => 'Search by POS devices.',
        'text_filter_devices' => 'View all devices',
