(function () {
  ...
  // PMD_EDIT_FOOD_FALLBACK_STATE_V2
  //
  // /brand/paymydine-logo.svg is a presentation fallback,
  // NOT a real food photograph.
  //
  // Never put it into the modal <img>. The native modal placeholder
  // owns the empty-image state.
  function isPmdFoodFallbackImageV2(src) {
  ...
  function setImagePreview(src) {
    ...
    /*
     * Empty / PayMyDine fallback:
     * native placeholder stays visible from first paint.
     */
    if (isPmdFoodFallbackImageV2(src)) {
    ...
    /*
     * Real food image:
     * keep placeholder behind the image until load completes.
     * Existing load listener adds has-image and hides placeholder.
     */
