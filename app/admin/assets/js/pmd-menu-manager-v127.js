(function () {
  ...
  function setExplicitJiggle(element, enabled, index) {
    ...
    var name = even ? 'pmd-menu-v127-jiggle-b' : 'pmd-menu-v127-jiggle-a';
  ...
  window.PMDMenuManagerV1 = {
    ...
    cacheBustedAssetAuthority: 'pmd-menu-manager-v127.js',
  ...
  console.info('[PMD Menu Manager V1.2.7] Ready', window.PMDMenuManagerV1);
})();
