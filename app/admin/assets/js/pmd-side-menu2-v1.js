...
/* PMD_SIDE_MENU2_CANCEL_EXTERNAL_TRANSFORM_V6_START */
(function () {
  'use strict';
  ...
  function cancelMenuMotion() {
    ...
    /*
     * Inline !important defeats late generic stylesheets.
     */
    menu.style.setProperty(
      'transform',
      'none',
    ...
    /*
     * Cancel CSS animations, CSS transitions and Web Animations
     * already attached by generic page-transition scripts.
     */
    if (
      typeof menu.getAnimations ===
      'function'
    ) {
      menu
        .getAnimations({
  ...
  function installMotionGuard() {
    ...
    /*
     * Protect against scripts that mutate inline styles later.
     */
    var observer = new MutationObserver(
      function (mutations) {
        var mustReset = mutations.some(
          function (mutation) {
            return (
              mutation.type ===
                'attributes' &&
    ...
    /*
     * Capture generic page animation events.
     */
    ...
    /*
     * Cover scripts executing across successive startup frames.
     */
    [
      0,
      16,
    ...
    window.PMDSideMenu2MotionGuard = {
      version: '6.0.0',
      apply: cancelMenuMotion,
      observer: observer
    };
...
/* PMD_SIDE_MENU2_CANCEL_EXTERNAL_TRANSFORM_V6_END */
