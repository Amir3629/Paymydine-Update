...
(function () {
    ...
    function mountCashierPanel() {
        ...
        panel.innerHTML = ''
            ...
            + '<div class="pmd-workplace-cashier-state">Restaurant device online</div>'
            + '</div>'
    ...
    function applyCode(payload) {
        ...
        if (link) {
            ...
            if (payload.code_expires_in) link.title = 'Workplace Code · changes in ' + String(payload.code_expires_in) + 's';
        }
