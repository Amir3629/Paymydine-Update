            ...
            while (buttonContainer.firstChild) {
                ...
                if (isSelectAll) {
                    ...
                    if (isCounter) {
                        ...
                        button.style.background = '#b8956a';
                    ...
                    if (isEnableDisable) {
                        ...
                        button.style.setProperty('background', '#d8b686', 'important'); // Same as New button
                        button.style.setProperty('background-color', '#d8b686', 'important');
                        button.style.setProperty('border', '1px solid #b8956a', 'important');
                        ...
                        button.addEventListener('mouseenter', function() {
                            this.style.setProperty('background', '#d8b686', 'important');
                            this.style.setProperty('background-color', '#d8b686', 'important');
