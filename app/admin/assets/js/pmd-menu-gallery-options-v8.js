...
(function () {
  ...
  function placeholderLike(url) {
    ...
    return (
      value.indexOf('paymydine') !== -1 ||
      value.indexOf('placeholder') !== -1 ||
      value.indexOf('no-image') !== -1 ||
      value.indexOf('no_image') !== -1 ||
      value.indexOf('fallback') !== -1 ||
      value.indexOf('default-food') !== -1 ||
      value.indexOf('pmd-placeholder') !== -1 ||
      value.indexOf('/brand/') !== -1
    );
  }
