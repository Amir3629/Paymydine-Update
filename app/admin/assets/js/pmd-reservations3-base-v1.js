(function () {
  ...
  if (window.PMDReservations3BaseV1) return;
  ...
  function init() {
    ...
    console.info('[PMD Reservations3 Base V1] Ready', window.PMDReservations3BaseV1);
    console.info('[PMD Reservations3 Clean Header V1] Ready', window.PMDReservations2CleanHeaderV3);
  }
