/* PayMyDine Owner/Admin Dashboard Clean v19
   Reference-style restaurant operations dashboard using the real v12 data model. */
(function () {
  'use strict';

  var VERSION = 'owner-clean-v19-final-reference-fit-20260626';
  var root = null;
  var lastData = null;
  ...
  function render(data) {
    ...
    root.innerHTML = '' +
      '<div class="pmd-v15-shell pmd-v19-shell">' +
        '<header class="pmd-v15-topbar pmd-v19-topbar">' +
        ...
        '<section class="pmd-v15-kpi-grid pmd-v19-kpi-grid">' +
        ...
        '<section class="pmd-v19-reference-grid">' +
        ...
        '<section class="pmd-v19-analytics-grid">' +
        ...
        '<section class="pmd-v19-bottom-grid">' +
