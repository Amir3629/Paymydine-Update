/* PayMyDine Owner/Admin Dashboard Clean v16
   Reference-style restaurant operations dashboard using the real v12 data model. */
(function () {
  'use strict';

  var VERSION = 'owner-clean-v16-exact-reference-20260626';
  var root = null;
  var lastData = null;
  ...
  function render(data) {
    ...
    root.innerHTML = '' +
      '<div class="pmd-v15-shell pmd-v16-shell">' +
        '<header class="pmd-v15-topbar pmd-v16-topbar">' +
        ...
        '<section class="pmd-v15-kpi-grid pmd-v16-kpi-grid">' +
        ...
        '<section class="pmd-v16-reference-grid">' +
          section('Live Restaurant Floor', 'Live · table coordinates + open-check status', floorPlan(s.floor_plan), 'pmd-v15-card--floor pmd-v16-area-floor', '<div class="pmd-v15-card-actions"><button type="button" data-pmd-owner-refresh>Refresh</button><a href="/admin/orders/create">New Order</a></div>') +
          section('Operations Alerts', 'Only owner-relevant connected issues', alerts(data), 'pmd-v15-card--alerts pmd-v16-area-alerts', '<a href="/admin/orders">View all</a>') +
          section('Recent Activity', 'Latest recorded orders and reservations', timeline(data), 'pmd-v15-card--timeline pmd-v16-area-timeline', '<a href="/admin/orders">View all</a>') +
        '</section>' +

        '<section class="pmd-v16-analytics-grid">' +
        ...
        '<section class="pmd-v16-bottom-grid">' +
          section('Top Servers', 'Connected staff overview; sales by server needs reliable assignment data', staffOverview(staff), 'pmd-v15-card--servers') +
