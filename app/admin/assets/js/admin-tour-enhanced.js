    ...
    const EnhancedAdminTour = {
        ...
        getSettingsTaxTour: function() {
            return [
                {
                    element: '.page-content, .nk-block, .card-inner',
                    intro: '<h3>VAT Settings Page</h3><p>This page lets you configure VAT settings for your restaurant. You can enable or disable VAT, set VAT rates, configure how VAT is applied to menu prices, and decide whether delivery charges are VAT-rated.</p><p style="margin-top: 8px; color: #333333;">VAT settings control how VAT is calculated and displayed on customer orders and invoices. Let\'s go through each setting one by one from top to bottom.</p>',
                    position: 'bottom'
                },
                {
                ...
                },
                {
                    ...
                    intro: '<h3>VAT Delivery Charge Toggle</h3><p>This toggle switch controls whether VAT is applied to delivery charges.</p><ul style="text-align: left; margin: 8px 0; color: #333333;"><li>Click "Yes" or toggle ON to apply VAT to delivery charges - delivery fee will be VAT-rated</li><li>Click "No" or toggle OFF to exclude delivery charges from VAT - delivery fee won\'t be VAT-rated</li><li>Example: If delivery is $5 and VAT is 10%, with "Yes" customer pays $5.50 for delivery, with "No" customer pays $5 flat</li><li>This only applies if VAT mode is enabled</li></ul>',
                    position: 'bottom'
                },
                {
