(function () {
  ...
  var KEY = 'pmdSidebarCollapsedV46';
  var OLD = ['pmdSidebarCollapsedV45','pmdSidebarCollapsedV44','pmdSidebarCollapsedV43','pmdSidebarCollapsedV42','pmdSidebarCollapsedV41'];
  ...
  function setWanted(v) {
    ...
    document.documentElement.classList.toggle('pmd-sidebar-persist-collapsed-v46', !!v);
  ...
  function isCollapsed() {
    ...
    return b.classList.contains('pmd-sidebar-icons-only') ||
      ...
      h.classList.contains('pmd-sidebar-persist-collapsed-v46');
  }
  ...
  function menu() {
    ...
    return s.querySelector('#side-nav-menu, .side-nav-menu, .sidebar-menu, .nav-sidebar, ul.nav, nav ul');
  }

  function realToggle() {
    return document.querySelector('.pmd-sidebar-icons-toggle:not(#pmd-sidebar-edge-toggle-v40):not(#pmd-sidebar-edge-toggle-v41):not(#pmd-sidebar-edge-toggle-v42):not(#pmd-sidebar-edge-toggle-v43):not(#pmd-sidebar-edge-toggle-v44):not(#pmd-sidebar-edge-toggle-v45):not(#pmd-sidebar-edge-toggle-v46)');
  }
  ...
  function clearOldArtifacts() {
    document.querySelectorAll('.pmd-collapsed-rail-v45, .pmd-collapsed-power-v45, #pmd-sidebar-edge-toggle-v40, #pmd-sidebar-edge-toggle-v41, #pmd-sidebar-edge-toggle-v42, #pmd-sidebar-edge-toggle-v43, #pmd-sidebar-edge-toggle-v44, #pmd-sidebar-edge-toggle-v45').forEach(function(el){
  ...
  function markNativeCollapsed() {
    var s = side();
    if (!s) return;

    // reset first
    s.querySelectorAll('.pmd-v46-hidden-native').forEach(function(el){ el.classList.remove('pmd-v46-hidden-native'); });

    if (!isCollapsed()) return;

    // hide native menu/footer areas only; keep logo and v46 proxies.
    var selectors = [
      '#side-nav-menu', '.side-nav-menu', '.sidebar-menu', '.nav-sidebar', '.pmd-sidebar-menu', '.sidebar-nav',
      '.sidebar-footer', '.pmd-sidebar-footer', '.pmd-sidebar-user', '.pmd-user-card'
    ];
    selectors.forEach(function(sel){
      s.querySelectorAll(sel).forEach(function(el){
        if (el.closest('.pmd-collapsed-rail-v46') || el.closest('.pmd-collapsed-power-v46')) return;
        if (el.classList.contains('pmd-platform-logo-slot-v38')) return;
        el.classList.add('pmd-v46-hidden-native');
      });
    });
  }
  ...
  function ensureRail() {
    ...
    var rail = s.querySelector('.pmd-collapsed-rail-v46');
    if (!rail) {
      rail = document.createElement('nav');
      rail.className = 'pmd-collapsed-rail-v46';
    ...
    var power = s.querySelector('.pmd-collapsed-power-v46');
    if (!power) {
      power = document.createElement('a');
      power.className = 'pmd-collapsed-power-v46';
  ...
  function ensureButton() {
    ...
    var btn = document.getElementById('pmd-sidebar-edge-toggle-v46');
    if (!btn) {
  ...
  function firstRailItem() {
    var s = side();
    return s ? s.querySelector('.pmd-collapsed-rail-v46 a') : null;
  }
  ...
  function positionButton() {
    ...
    document.documentElement.style.setProperty('--pmd-sidebar-edge-left-v46', left + 'px');
    document.documentElement.style.setProperty('--pmd-sidebar-edge-top-v46', top + 'px');
  ...
  function persistLinks() {
    document.querySelectorAll('#side-nav-menu a[href], .side-nav-menu a[href], .sidebar-menu a[href], .nav-sidebar a[href], .pmd-collapsed-rail-v46 a[href]').forEach(function(a){
      if (a.getAttribute('data-pmd-sidebar-persist-v46')) return;
      a.setAttribute('data-pmd-sidebar-persist-v46','1');
  ...
  ready(function(){
    ...
    window.PMDSidebarEmergencyCleanV46 = {
      apply: applyAll,
