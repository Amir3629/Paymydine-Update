/* PMD_DASHBOARD_ROUTE_GUARD_V50_START */
(function () {
  var __pmdDashboardPathV50 = String((window.location && window.location.pathname) || '');
  var __pmdDashboardAllowedV50 =
    __pmdDashboardPathV50 === '/admin/dashboard' ||
    __pmdDashboardPathV50.indexOf('/admin/dashboard/') === 0;

  window.PMD_DASHBOARD_ROUTE_GUARD_V50 = {
    path: __pmdDashboardPathV50,
    allowed: __pmdDashboardAllowedV50
  };

  if (!__pmdDashboardAllowedV50) {
    console.info('[PMD] dashboard role JS skipped on non-dashboard page', window.PMD_DASHBOARD_ROUTE_GUARD_V50);
    return;
  }

/* PayMyDine Owner/Admin Dashboard Clean v9
   Owner-first dashboard: compact KPI header + floor plan + reliable console health API. */
(function () {
  'use strict';

  var VERSION = 'owner-clean-v9-native-match-20260625';
  var root = null;
    ...
    root.innerHTML = '' +
      '<div class="pmd-owner-clean-shell">' +
        ...
        '<div class="pmd-owner-clean-grid pmd-owner-clean-grid--two">' +
          section('Service Mix', 'Dine-in / takeaway / delivery / cashier distribution if order_type exists.', serviceMix(data)) +
  ...
  function exposeApi() {
    var api = {
      ...
      nativeMatch: function () { return {operations: safeGet(['sections', 'operations'], {}), floor_plan: safeGet(['sections','floor_plan'], null), recent_orders: safeGet(['sections','recent_orders'], [])}; },
...
/* PMD_DASHBOARD_ROUTE_GUARD_V50_END */
