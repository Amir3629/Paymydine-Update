(function () {
  ...
  var excluded =
    ...
    /* PMD_SHIFTS_EXACT_LAYOUT_BYPASS_FINAL
     * Shifts owns final geometry before first paint.
     * Never rewrite its wrapper/content after load.
     */
    path.indexOf('/admin/shifts') === 0 ||
    path.indexOf('/admin/reservations') === 0 ||
