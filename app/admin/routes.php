...
App::before(function () {
    ...
    Route::group([
         ...
         * 
         * @param int $locationId The location ID to get permalink_slug from
         * @param string $path The path to append (e.g., '/table/5')
         * @param array $qs Query string parameters
         * @return string The full tenant-specific URL
         * @throws \Exception If location has no permalink_slug
         */
