...
@section('content')
<div class="hero"><div><h2>Platform overview</h2><p>Central view of PayMyDine restaurants and provisioning state.</p></div><a class="btn btn-primary" href="/superadmin/new">+ Create restaurant</a></div>
<div class="stats">
