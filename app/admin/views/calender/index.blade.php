...
<script>window.PMD_YEAR_CALENDAR_BOOT={version:'1.6.0',route:'/admin/calender',year:@json($calendarYear),today:@json(now()->format('Y-m-d')),reservations:@json($calendarReservations ?? []),events:@json($calendarEvents ?? []),reports:@json($calendarReports ?? []),reservationCreateUrl:@json(admin_url('reservations/create')),reservationEditBaseUrl:@json(admin_url('reservations/edit'))};</script>
...
<div id="pmd-year-calendar" class="pmd-yc" aria-busy="true">
  <div class="pmd-yc__toolbar">
    <div class="pmd-yc__legend" aria-label="Calendar legend"><span><i class="is-reservation">R</i>Reservation</span><span><i class="is-football">⚽</i>Football</span><span><i class="is-event">★</i>Germany event</span><span><i class="is-report">€</i>Day report</span></div>
