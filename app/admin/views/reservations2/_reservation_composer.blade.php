    ...
    <div class="modal-content">
      <form id="pmd-reservation-composer-form-v1" novalidate>
        ...
        <div class="pmd-reservation-composer-v1__content" data-pmd-composer-content hidden>
          ...
          <details class="pmd-reservation-composer-v1__more">
            <summary>More options <svg aria-hidden="true"><use href="#pmd-composer-icon-chevron-down"/></svg></summary>
            <div class="pmd-reservation-composer-v1__grid">
              <label><span>@lang('admin::lang.label_status')</span><select name="status_id"></select><em data-error-for="status_id"></em></label>
              <label><span>Occasion</span><select name="occasion_id"></select><em data-error-for="occasion_id"></em></label>
              <label class="pmd-reservation-composer-v1__location" data-pmd-composer-location hidden><span><svg aria-hidden="true"><use href="#pmd-composer-icon-map-pin"/></svg>@lang('admin::lang.reservations.text_restaurant')</span><select name="location_id"></select><em data-error-for="location_id"></em></label>
              <label class="pmd-reservation-composer-v1__check"><input name="notify" type="checkbox" value="1"><span><svg aria-hidden="true"><use href="#pmd-composer-icon-bell"/></svg>@lang('admin::lang.reservations.label_send_confirmation')</span></label>
            </div>
          </details>
        </div>
