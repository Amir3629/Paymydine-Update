...
<script defer
        src="{{ asset('app/admin/assets/js/pmd-reservations2-floor-toolbar-v316.js') }}?v=20260730_d1-2-floor-colors-v1"></script>

<!-- V464 owns the real Floor toolbar without reparenting. -->
...
<!-- One Row geometry is rendered synchronously by pmd-floor-v1.js. -->




{{-- V464 is the single Floor toolbar authority. --}}
