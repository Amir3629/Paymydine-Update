...
<section class="pmd-owner-section" id="payment-providers">
            <div class="pmd-owner-card" data-accent="orange">
                <div class="pmd-owner-card__header">
                    ...
                    <div class="pmd-owner-card__title"><h2>{{ $pmdSettingsText('Payment providers') }}</h2><p>{{ $pmdSettingsText('Each restaurant connects its own provider account once. Payment methods and terminal devices reuse that connection.') }}</p></div>
                </div>
                            ...
                            @forelse($providers as $provider)
                                <div class="pmd-owner-list-row">
                                    <div>
                                        ...
                                        <small>{{ $pmdSettingsText(!empty($provider->status) ? 'Connected/configured for this restaurant' : 'Not configured yet') }}</small>
                                    </div>
        ...
        <section class="pmd-owner-section" id="payment-methods">
            <div class="pmd-owner-card" data-accent="orange">
                <div class="pmd-owner-card__header">
                    ...
                    <div class="pmd-owner-card__title"><h2>{{ $pmdSettingsText('Payment methods') }}</h2><p>{{ $pmdSettingsText('Guest-facing payment choices and the provider powering each method.') }}</p></div>
                    <div class="pmd-owner-card__actions"><span class="pmd-owner-meta">{{ $pmdSettingsText('Edit here — no detail-page navigation') }}</span></div>
                </div>
                <div class="pmd-owner-card__body">
