...
{{-- PMD_RESERVATIONS_BELOW_FLOOR_CARDS_V2_1 --}}
@php
    $pmdOpsSchedule = $pmdReservationsSchedule ?? [];
    ...
    $pmdOpsRange = [
        'base_url' => admin_url('reservations'),
        'from' => $pmdOpsFrom,
        'to' => $pmdOpsTo,
        'today' => $pmdOpsToday,
...
<section
    ...
    id="pmd-reservations-cards-v2-1"
...
>
    ...
    {{-- PMD_RESERVATIONS_ADD_CARD_FIRST_V1
         ...
         Reservations Composer on click. --}}
