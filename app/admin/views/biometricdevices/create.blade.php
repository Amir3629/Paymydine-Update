...
<div class="pmd-owner-page pmd-device-suite-page" data-pmd-owner-page data-pmd-device-suite="biometric_devices-create">
    @include('admin::pmddevices._suite_header', [
        'pmdSuiteTitle' => 'Create biometric device',
