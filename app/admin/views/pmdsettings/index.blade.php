    ...
    >
        ...
        >
            <a
                ...
                {{-- PMD_ANDROID_POS_PREVIEW_V7_OFFLINE_HISTORY_IMAGES_SINGLE_LOGIN --}}
                href="{{ url('/downloads/paymydine/PayMyDine-Android-0.3.8.apk') }}"
                target="_blank"
            ...
            >
                ...
                <span class="pmd-cashier-launcher-v107__copy">
                    ...
                    <small>Android 8+ · Operations Preview 0.3.8</small>
                </span>
            </a>
