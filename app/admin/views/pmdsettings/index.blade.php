    ...
    >
        ...
        >
            <a
                ...
                {{-- PMD_ANDROID_POS_PREVIEW_V5_CANONICAL_LOGIN_OFFLINE --}}
                href="{{ url('/downloads/paymydine/PayMyDine-Android-0.3.5.apk') }}"
                target="_blank"
            ...
            >
                ...
                <span class="pmd-cashier-launcher-v107__copy">
                    ...
                    <small>Android 8+ · Operations Preview 0.3.5</small>
                </span>
            </a>
