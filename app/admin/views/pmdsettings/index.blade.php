    ...
    >
        ...
        >
            <a
                ...
                {{-- PMD_ANDROID_POS_PREVIEW_V6_OFFLINE_FAILOVER_LOGIN_FRAME --}}
                href="{{ url('/downloads/paymydine/PayMyDine-Android-0.3.6.apk') }}"
                target="_blank"
            ...
            >
                ...
                <span class="pmd-cashier-launcher-v107__copy">
                    ...
                    <small>Android 8+ · Operations Preview 0.3.6</small>
                </span>
            </a>
