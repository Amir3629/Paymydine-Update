...
$config['form']['tabs'] = [
    ...
    'fields' => [
        ...
        'is_halal' => [
            'label' => 'Halal',
            'tab' => 'Food Attributes & Allergies',
            'type' => 'switch',
            'span' => 'left',
            'default' => 0,
            'comment' => 'Display-only customer information tag.',
        ],
        'is_vegetarian' => [
            'label' => 'Vegetarian',
            'tab' => 'Food Attributes & Allergies',
        ...
        'allergens' => [
            ...
            'type' => 'relation',
            'span' => 'right',
            'comment' => 'Display tags only. Restaurants remain responsible for the information shown to customers.',
        ],
        'mealtimes' => [
