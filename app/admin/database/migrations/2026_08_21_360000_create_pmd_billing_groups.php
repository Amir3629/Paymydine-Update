...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('pmd_billing_group_orders')) {
            Schema::create('pmd_billing_group_orders', function (Blueprint $table): void {
                ...
                $table->timestamps();
                $table->unique(['billing_group_id', 'order_id'], 'pmd_bgo_group_order_uq');
            });
        }
    ...
    {
        // Intentionally non-destructive: financial evidence may exist after deployment.
        // Application rollback must tolerate the additive R36 tables.
    }
};
