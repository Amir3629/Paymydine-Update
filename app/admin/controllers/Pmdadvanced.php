...
class Pmdadvanced extends AdminController
{
    ...
    public function onSaveAdvanced()
    {
        ...
        $values = [
            ...
            'enable_customer_eta' => (int)$this->settingValue('enable_customer_eta', 1),
            'smart_eta_enabled' => (int)$this->settingValue('smart_eta_enabled', 1),
            'eta_default_prep_minutes' => (int)$this->settingValue('eta_default_prep_minutes', 20),
            'eta_order_load_window_minutes' => (int)$this->settingValue('eta_order_load_window_minutes', 30),
            'eta_busy_item_threshold' => (int)$this->settingValue('eta_busy_item_threshold', 10),
            'eta_very_busy_item_threshold' => (int)$this->settingValue('eta_very_busy_item_threshold', 20),
            'eta_busy_extra_minutes' => (int)$this->settingValue('eta_busy_extra_minutes', 5),
            'eta_very_busy_extra_minutes' => (int)$this->settingValue('eta_very_busy_extra_minutes', 10),
            'eta_use_staff_attendance' => (int)$this->settingValue('eta_use_staff_attendance', 0),
            'eta_expected_kitchen_staff' => (int)$this->settingValue('eta_expected_kitchen_staff', 2),
            'eta_understaffed_extra_minutes' => (int)$this->settingValue('eta_understaffed_extra_minutes', 5),
            'eta_round_to_nearest_minutes' => (int)$this->settingValue('eta_round_to_nearest_minutes', 5),
            'eta_max_minutes' => (int)$this->settingValue('eta_max_minutes', 240),
            'eta_hint_text' => (string)$this->settingValue('eta_hint_text', ''),
