...
>
    <div class="widget-item pmd-dashboard-widget-root card {{ $widget->getCssClass() }} @if(strpos($widgetAlias, 'stat_') === 0 || strpos($widgetAlias, 'chart_') === 0) no-padding @else p-3 @endif shadow-sm">
