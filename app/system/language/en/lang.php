...
return [
    ...
    'settings' => [
        ...
        'text_menu_price_include_tax' => 'Menu prices already include VAT',
        'text_apply_tax_on_menu_price' => 'Apply VAT in checkout bill',
        ...
        'label_tax_title' => 'VAT Title',
        'label_tax_percentage' => 'VAT Rate',
        'label_tax_menu_price' => 'VAT Menu Price',
        'label_tax_delivery_charge' => 'VAT Delivery Charge',
        ...
        'label_invoice_prefix' => 'Invoice Number Prefix',
        'label_invoice_logo' => 'Logo',
        'label_invoice_receipt_mode' => 'Thermal Receipt Mode',
        'label_invoice_paper_width' => 'Receipt Paper Width',
        'label_invoice_auto_print_after_paid' => 'Auto Print Receipt After Paid Order',
        'label_invoice_auto_print_dialog' => 'Auto Open Print Dialog on Invoice Page',
        'label_invoice_show_logo' => 'Show Logo on Receipt',
        'label_invoice_show_qr' => 'Show QR on Receipt',
        'label_invoice_show_fiskaly' => 'Show Fiskaly/TSE Details',
        'label_invoice_compact_mode' => 'Compact Receipt Mode',
        'label_invoice_font_size_preset' => 'Receipt Font Size Preset',
        'label_invoice_print_hint' => 'Print Hint Text',
        'help_invoice_logo' => 'Upload a logo to display on invoices',
        'help_invoice_receipt_mode' => 'Enable thermal-receipt-friendly rendering for order invoices.',
        'help_invoice_paper_width' => 'Select receipt width for invoice print layout.',
        'help_invoice_auto_print_after_paid' => 'When enabled, paid-order automation can trigger receipt printing flows (if supported by your POS workflow).',
        'help_invoice_auto_print_dialog' => 'Automatically open the browser print dialog when invoice page is loaded.',
        'help_invoice_show_logo' => 'Show restaurant logo at the top of printed receipt.',
        'help_invoice_show_qr' => 'Show Fiskaly/TSE QR code on receipt when data is available.',
        'help_invoice_show_fiskaly' => 'Show compact Fiskaly/TSE compliance details.',
        'help_invoice_compact_mode' => 'Use tighter spacing for thermal printers.',
        'help_invoice_font_size_preset' => 'Choose small or normal font size preset for receipts.',
        'help_invoice_print_hint' => 'Admin-friendly reminder shown in settings for reliable browser print configuration.',
        ...
        'help_tax_mode' => 'Set whether to enable or disable calculating VAT in storefront',
        'help_tax_title' => 'Enter the VAT title as it should be displayed on storefront. Ex. VAT',
        'help_tax_percentage' => 'Enter the percentage to calculate VAT. Ex. 15',
        'help_tax_menu_price' => 'Set whether menu price already includes VAT or VAT should be calculated on menu price',
        'help_tax_delivery_charge' => 'Set whether delivery charge is VAT taxable',
        ...
        'help_invoice_prefix' => 'Use macros like {year}, {month}, {day}. Example: INV-{year}{month}-.',
