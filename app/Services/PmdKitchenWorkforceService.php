...
class PmdKitchenWorkforceService
{
    ...
    public function snapshot(int $locationId, ?Carbon $at = null): array
    {
        ...
        try {
            ...
            if ($shift) {
                ...
                // Device attendance is optional and only valid for Kitchen roster
                // people explicitly linked to a PMD staff account.
    ...
    public function currentShift(int $locationId, ?Carbon $at = null)
    {
        ...
        // First resolve active shifts precisely, including an overnight shift
        // that began yesterday and ends after midnight today.
        foreach ($rows as $row) {
