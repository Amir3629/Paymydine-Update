...
<div id="pmd-reservations2" class="pmd-r2" aria-busy="true">
    ...
    {{-- PMD_R2_INLINE_FLOOR_TOOLBAR_V35_BEGIN --}}

    <style id="pmd-r2-inline-floor-toolbar-v35-style">
        /*
         * A normal-flow row between KPI cards and the Floor map.
         * No absolute positioning, no wrapper and no DOM movement.
         */
        #pmd-r2-inline-floor-toolbar-v35 {
        ...
        #pmd-r2-inline-floor-toolbar-v35 > button {
        ...
        #pmd-r2-inline-floor-toolbar-v35 > button:hover {
        ...
        /*
         * V28 already removes the obsolete toolbar inside the Floor.
         * Keep the Floor itself in its normal location.
         */
    ...
    <div
        id="pmd-r2-inline-floor-toolbar-v35"
        role="toolbar"
        aria-label="Reservation Floor controls"
    >
        <button
            type="button"
            data-pmd-v35-floor-action="edit"
        >
            {{ app()->getLocale() === 'de' ? 'Bearbeiten' : 'Edit' }}
        </button>

        <button
            type="button"
            data-pmd-v35-floor-action="zoom-out"
            aria-label="Zoom out"
        >
            −
        </button>
        ...
        <button
            type="button"
            data-pmd-v35-floor-action="zoom-in"
            aria-label="Zoom in"
        >
            +
        </button>
        ...
        <button
            type="button"
            data-pmd-v35-floor-action="strip"
        >
            {{ app()->getLocale() === 'de' ? 'Eine Reihe' : 'One row' }}
        </button>
    </div>

    <script id="pmd-r2-inline-floor-toolbar-v35-script">
    (function () {
        'use strict';
        ...
        var selectors = {
            edit: '[data-floor-edit]',
            'zoom-out': '[data-floor-zoom-out]',
            fit: '[data-floor-fit]',
            'zoom-in': '[data-floor-zoom-in]',
            strip: '[data-floor-strip]'
        };
        ...
        function handleClick(event) {
            ...
            if (!nativeButton) {
                console.error(
                    '[PMD V35] Native Floor control missing:',
                    action
                );
        ...
        function boot() {
            ...
            console.info(
                '[PMD Reservations V35] ' +
                'Inline Floor toolbar ready'
            );
        }
    ...
    {{-- PMD_R2_INLINE_FLOOR_TOOLBAR_V35_END --}}
