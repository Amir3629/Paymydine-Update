...
function renderSelected() {
    ...
    /*
     * PMD Day View Month Navigation V9
     *
    ...
    function shiftSelectedMonth(delta) {
      ...
      var sourceYear = parts[0];
      var sourceMonth = parts[1] - 1;
      var sourceDay = parts[2];
  ...
  function audit() {
    ...
    return {
      ...
      selectedExists: Boolean(
        root && root.querySelector('[data-r2-yc-selected]')
      ),
      selectedInsideFunctionalRoot: Boolean(
        root &&
        root.contains(root.querySelector('[data-r2-yc-selected]'))
      ),
      selectedInsideCalendarFrame: Boolean(
        root &&
        root.querySelector('[data-r2-yc-calendar-frame]') &&
        root.querySelector('[data-r2-yc-calendar-frame]').contains(
          root.querySelector('[data-r2-yc-selected]')
        )
      ),
  ...
  function init() {
    ...
    console.info('[PMD Reservations2 Calendar Toggle V1.16] Ready', audit());
  }
