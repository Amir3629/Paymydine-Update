...
{{-- PMD_R2_STABLE_FLOOR_TOOLBAR_V36_BEGIN --}}

<style id="pmd-r2-stable-floor-toolbar-v36-style">
    #pmd-r2-stable-floor-toolbar-v36 {
    ...
    #pmd-r2-stable-floor-toolbar-v36 > button {
    ...
    #pmd-r2-stable-floor-toolbar-v36 > button:hover {
...
<script id="pmd-r2-stable-floor-toolbar-v36-script">
(function () {
    'use strict';
    ...
    function createToolbar() {
        ...
        toolbar.addEventListener(
            ...
            function (event) {
                ...
                if (!nativeButton) {
                    console.error(
                        '[PMD V36] Native Floor button missing:',
                        action
                    );
    ...
    function mount() {
        ...
        /*
         * Toolbar must be a normal-flow sibling
         * immediately before the Floor.
         */
        if (
            ...
            floor.parentElement.insertBefore(
                toolbar,
                floor
            );
        }
    ...
    function startTemporaryGuard() {
            ...
            new MutationObserver(
                function () {
                    ...
                    if (
                        !floor ||
                        !toolbar ||
                        toolbar.nextElementSibling !== floor
                    ) {
                        queueMount();
                    }
                }
        ...
        /*
         * The guard exists only while the page's old scripts
         * finish rebuilding the Reservations DOM.
         */
        observerTimer =
            window.setTimeout(
                function () {
                    ...
                    console.info(
                        '[PMD V36] Temporary DOM guard stopped.'
                    );
                },
                8000
            );
        ...
        audit: function () {
            ...
            return {
                ...
                toolbarParent:
                    toolbar &&
                    toolbar.parentElement
                        ? toolbar.parentElement.id ||
                          toolbar.parentElement.className
                        : '',
...
{{-- PMD_R2_STABLE_FLOOR_TOOLBAR_V36_END --}}
