...
<head>
    ...
    <style id="pmd-v252-prepaint">
        html:not(.pmd-v252-ready) [data-pmd-waiter-v2-root] .pmd-v2-mode-keys,
        html:not(.pmd-v252-ready) [data-pmd-waiter-v2-root] [data-v2-area-row],
        html:not(.pmd-v252-ready) [data-pmd-waiter-v2-root] [data-v2-table-grid],
        html:not(.pmd-v252-ready) [data-pmd-waiter-v2-root] [data-v2-empty] {
            visibility: hidden !important;
        }
        html:not(.pmd-v252-ready) [data-pmd-waiter-v2-root]::after {
            content: "LOADING FLOOR...";
            position: fixed;
            left: 50%;
            top: 52%;
    ...
    <script id="pmd-v252-prepaint-script">
        document.documentElement.classList.remove('pmd-v252-ready');
    </script>
...
<script src="{{ asset('app/admin/assets/js/pmd-waiter-v252-final-runtime.js') }}?v=252-20260716"></script>
</body>
</html>
