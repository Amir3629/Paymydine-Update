...
- `pmd-frontend-v2-theme.php`: read-only `GET /api/v1/frontend-theme-v2` with all 10 canonical V2 Theme IDs.
...
Then verify both `/api/v1/frontend-theme-v2` and `/simple-theme` return successfully before restarting or changing any customer frontend upstream.
