...
>
    <div class="modal-dialog dashboard-widget-modal-dialog" role="document">
        <div id="<?php echo e($this->getId('new-widget-modal-content')); ?>" class="modal-content dashboard-widget-modal">
...
body.edit-mode-active #<?php echo e($this->alias); ?>-daterange {
    display: none !important;
}
</style>
...
function toggleEditMode() {
    ...
    const dateRangeButton = document.getElementById('<?php echo e($this->alias); ?>-daterange');
...
<?php /**PATH /var/www/paymydine/app/admin/widgets/dashboardcontainer/widget_toolbar.blade.php ENDPATH**/ ?>