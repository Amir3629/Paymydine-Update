<div id="<?php echo e($this->getId()); ?>" class="dashboard-widget widget-cache">
    ...
    <div class="cache-donut">
        <span class="cache-total-text">
            <span class="cache-label"><?php echo e(__('Cache')); ?></span>
            <b><?php echo e($formattedTotalCacheSize); ?></b>
        </span>
    <div class="progress mb-3" style="height: 25px;">
        <?php $__currentLoopData = $cacheSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cacheInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div
                ...
                aria-valuetext="<?php echo e($cachePercent); ?>"
                aria-valuemin="0"
                aria-valuemax="<?php echo e($totalCacheSize); ?>"
                style="<?php echo e('background-color: '.$cacheInfo->color.'; width: '.$cachePercent.'%'); ?>"
...
<?php /**PATH /var/www/paymydine/app/system/dashboardwidgets/cache/cache.blade.php ENDPATH**/ ?>