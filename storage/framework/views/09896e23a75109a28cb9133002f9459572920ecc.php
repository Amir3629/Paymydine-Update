    ...
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($item->itemName === 'settings'): ?>
            ...
            <li class="nav-item dropdown" id="notif-root">
              <span title="Notifications" class="media-toolbar-tooltip-wrap">
              ...
              <div class="dropdown-menu dropdown-menu-right p-0 shadow"
                ...
                <div class="d-flex align-items-center justify-content-between px-3 py-2 border-bottom gap-2" style="flex-wrap: nowrap;">
                  ...
                  <div class="d-flex align-items-center gap-2" style="flex-shrink: 0; margin-left: auto;">
                    <button id="notif-note-btn" class="btn btn-light btn-sm" type="button" title="Add General Staff Note" aria-label="Add General Staff Note">
                      <?php echo e(__('Note')); ?>

                    </button>
                  <a id="notif-history-link" class="btn btn-light btn-sm" href="<?php echo e(url('/admin/history')); ?>" title="View History" aria-label="View History">
            ...
            const updateToggleLabel = (enabled) => {
                if (notifToggleLabel) {
                    notifToggleLabel.textContent = enabled ? '<?php echo e(__('On')); ?>' : '<?php echo e(__('Off')); ?>';
                }
            };
            if (notifToggle) {
                ...
                notifToggle.addEventListener('change', function () {
                    ...
                    this.disabled = true;
                    fetch('<?php echo e(admin_url('statuses')); ?>', {
                        method: 'POST',
...
<?php /**PATH /var/www/paymydine/app/admin/widgets/menu/top_menu.blade.php ENDPATH**/ ?>