...
<body>
<?php if(request()->get('pmd_debug') == '1'): ?>
    <?php
...
-------------------------
order_id: <?php echo e($__dbgOrderId); ?>

connection: <?php echo e($__dbgConn ?: 'n/a'); ?>

menus_count: <?php echo e(count($__dbgMenuRows)); ?>

totals_count: <?php echo e(count($__dbgTotalRows)); ?>

error: <?php echo e($__dbgError ?: 'none'); ?>


MENUS:
<?php echo e(json_encode($__dbgMenuRows, JSON_PRETTY_PRINT|JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES)); ?>


TOTALS:
<?php echo e(json_encode($__dbgTotalRows, JSON_PRETTY_PRINT|JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES)); ?>
...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <div class="invoice-title">
                ...
                <h3><?php echo app('translator')->get('admin::lang.orders.label_order_id'); ?> #<?php echo e($model->order_id); ?></h3>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 text-center" style="margin-bottom: 8px;">
            <?php if(setting('invoice_logo') || setting('site_logo')): ?>
                <img class="img-responsive" src="<?php echo e(uploads_url(setting('invoice_logo') ?: setting('site_logo'))); ?>" alt="" style="max-height:50px; margin-bottom:5px;" />
                <br>
            <?php endif; ?>

            <p style="margin-bottom: 4px;">
                <span style="font-size: 13px; font-weight: 600;"><?php echo e($model->location->location_name); ?></span>
            </p>

            <address style="font-style: normal; font-size: 9px;">
                <?php echo e(format_address($model->location->getAddress(), true)); ?>

                <?php if($model->location->location_telephone): ?>
                    <br><strong>Tel:</strong> <?php echo e($model->location->location_telephone); ?>

                <?php endif; ?>
                <?php if($model->location->location_email): ?>
                    <br><strong>Email:</strong> <?php echo e($model->location->location_email); ?>
    ...
    <div class="row">
        <div class="col-6" style="width:50%; float:left;">
            ...
            <p style="font-size:9px;">
                ...
                <?php if($model->invoice_date): ?>
                    <?php echo e($model->invoice_date->format(lang('system::lang.php.date_format'))); ?>

                <?php elseif($model->order_date): ?>
                    <?php echo e($model->order_date->format(lang('system::lang.php.date_format'))); ?>
...
<tbody>
                    ...
                    ?>
                    <?php $__currentLoopData = $__invoiceMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <tr>
                            <td class="text-center"><?php echo e((int)$menuItem->quantity); ?>x</td>
                            <td class="text-left">
                                <b><?php echo e($menuItem->name); ?></b>

                                <?php if($__menuItemOptionGroup->isNotEmpty()): ?>
                                    <?php $__currentLoopData = $__menuItemOptionGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $__groupName => $__groupItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div style="font-size:8px; margin-top:3px; line-height:1.45;">
                                            <?php if(!empty($__groupName)): ?>
                                                <strong><?php echo e($__groupName); ?>:</strong><br>
                                            <?php endif; ?>

                                            <?php $__currentLoopData = $__groupItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $__opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                &nbsp;&nbsp;— <?php echo e($__opt->order_option_name); ?>

                                                <?php if($__optPrice > 0): ?>
                                                    (<?php echo e(currency_format($__optTotal)); ?>)
                                                <?php endif; ?>
                                                <br>
                            ...
                            <td class="text-right"><?php echo e(currency_format($__unitDisplayPrice)); ?></td>
                            <td class="text-right"><?php echo e(currency_format($__lineDisplaySubtotal ?? $__lineSubtotal)); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    ...
                    <?php if($displaySubtotal > 0): ?>
                        <tr>
                            <td class="thick-line"></td>
                            <td class="thick-line text-left">
                                <?php echo e($model->order_type_name); ?>

                                <?php if($displayItems > 0): ?>
                                    (<?php echo e($displayItems); ?> item<?php echo e($displayItems > 1 ? 's' : ''); ?>)
                                <?php endif; ?>
                            </td>
                            <td class="thick-line"></td>
                            <td class="thick-line text-right"><?php echo e(currency_format($displaySubtotal)); ?></td>
                        </tr>
                    <?php endif; ?>

                    <?php if($__pmdTaxIncluded): ?>
                        <tr>
                            <td class="no-line"></td>
                            <td class="no-line text-left">VAT included</td>
                            <td class="no-line"></td>
                            <td class="no-line text-right">(<?php echo e(rtrim(rtrim(number_format((float) $__pmdReadTaxSetting('tax_percentage', 0), 2, '.', ''), '0'), '.')); ?>%)</td>
                        </tr>
                    <?php elseif($__taxTotal && (float)$__taxTotal->value > 0): ?>
                        <tr>
                            <td class="no-line"></td>
                            <td class="no-line text-left"><?php echo e($__taxTotal->title ?: 'VAT'); ?></td>
                            <td class="no-line"></td>
                            <td class="no-line text-right"><?php echo e(currency_format((float)$__taxTotal->value)); ?></td>
                        </tr>
                    <?php endif; ?>

                    <?php if($tipTotal && (float)$tipTotal->value > 0): ?>
                        <tr>
                            <td class="no-line"></td>
                            <td class="no-line text-left"><?php echo e($tipTotal->title ?: 'Tip'); ?></td>
                            <td class="no-line"></td>
                            <td class="no-line text-right"><?php echo e(currency_format((float)$tipTotal->value)); ?></td>
                        </tr>
                    <?php endif; ?>

                    <?php if($couponTotal && (float)$couponTotal->value != 0): ?>
                        <tr>
                            <td class="no-line"></td>
                            <td class="no-line text-left">
                                <?php echo e($couponTotal->title ?: 'Coupon'); ?>
                            ...
                            <td class="no-line text-right">
                                <?php echo e((float)$couponTotal->value < 0 ? '-' : ''); ?><?php echo e(currency_format(abs((float)$couponTotal->value))); ?>
                    ...
                    <tr>
                        <td class="thick-line"></td>
                        <td class="thick-line text-left"><strong><?php echo e($finalTotal->title ?? 'Total'); ?></strong></td>
                        <td class="thick-line"></td>
                        <td class="thick-line text-right"><strong><?php echo e(currency_format($displayFinal)); ?></strong></td>
                    </tr>
                    </tfoot>
            ...
            <div class="pmd-fiskaly-grid">
                <?php if(!empty($__fQr)): ?>
                    <div class="pmd-fiskaly-qr">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=<?php echo e(urlencode($__fQr)); ?>" alt="Fiskaly QR Code">
                    </div>
                <?php endif; ?>

                <div class="pmd-fiskaly-meta">
                    <?php if(!empty($__fStatus)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-label">Fiskaly Status</span>
                            <span class="pmd-fiskaly-value"><?php echo e($__fStatus); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($__fTxId)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-label">Transaction Ref</span>
                            <span class="pmd-fiskaly-value"><?php echo e($__fTxId); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($__fTxNo)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-label">TSE Transaction No.</span>
                            <span class="pmd-fiskaly-value"><?php echo e($__fTxNo); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($__fCounter)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-label">Signature Counter</span>
                            <span class="pmd-fiskaly-value"><?php echo e($__fCounter); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($__fSerial)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-label">Serial Number</span>
                            <span class="pmd-fiskaly-value"><?php echo e($__fSerial); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($__fTssId)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-value"><?php echo e($__fTssId); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($__fClientId)): ?>
                        <div class="pmd-fiskaly-row">
                            <span class="pmd-fiskaly-value"><?php echo e($__fClientId); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH /var/www/paymydine/app/admin/views/orders/invoice.blade.php ENDPATH**/ ?>