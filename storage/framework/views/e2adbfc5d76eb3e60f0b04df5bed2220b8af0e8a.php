...
<head>
    ...
    <style>
        :root {
            --theme-color: <?php echo e($themeColor ?? '#4CAF50'); ?>;
            --theme-color-light: <?php echo e($themeColor ?? '#4CAF50'); ?>33;
        }
...
<body>
    ...
    <div class="kds-container">
        ...
        <div class="kds-header">
            <div class="kds-header-left">
                ...
                <div class="kds-stat">
                    <span>Orders:</span>
                    <span class="kds-stat-value" id="order-count"><?php echo e(count($orders)); ?></span>
                </div>
                <div class="kds-stat">
                    <span>Reservations:</span>
                    <span class="kds-stat-value" id="reservations-count"><?php echo e($reservationsCount); ?></span>
                </div>
            </div>
            <div class="kds-header-right">
                <?php if(isset($allStations) && count($allStations) > 0): ?>
                <select class="station-selector" id="station-selector" onchange="changeStation(this.value)">
                    <option value="">All Stations</option>
                    <?php $__currentLoopData = $allStations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($s->slug); ?>" <?php echo e((isset($station) && $station && $station->slug === $s->slug) ? 'selected' : ''); ?>>
                        <?php echo e($s->name); ?>
                ...
                <a href="<?php echo e(admin_url('kds_stations')); ?>" class="settings-btn" title="Manage KDS Stations">
        ...
        <div class="orders-grid" id="orders-grid">
            <?php if(count($orders) === 0): ?>
                <div class="empty-state" style="grid-column: 1 / -1;">
                    ...
                    <h2>All Caught Up!</h2>
                    <p>No active orders <?php echo e(isset($station) && $station ? 'for ' . $station->name : 'in the kitchen'); ?></p>
                </div>
            <?php else: ?>
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="order-card <?php echo e($ageClass); ?>" data-order-id="<?php echo e($order['order_id']); ?>">
                        <div class="order-header">
                            <div>
                                <div class="order-number">#<?php echo e($order['order_id']); ?></div>
                                <div class="order-table"><?php echo e($order['order_type_name']); ?></div>
                            </div>
                            <div class="order-time">
                                <span class="order-time-label">Time Elapsed</span>
                                <div class="order-elapsed <?php echo e($elapsedMinutes > 15 ? 'late' : ''); ?>" 
                                     data-created="<?php echo e($order['created_at']->timestamp); ?>">
                                    <?php echo e($order['elapsed_time']); ?>
                        ...
                        <div class="order-items">
                            <?php $__currentLoopData = $order['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="order-item">
                                    ...
                                    <?php if(count($item['modifiers']) > 0): ?>
                                        <div class="item-modifiers">
                                            <?php $__currentLoopData = $item['modifiers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item-modifier">
                                                    <i class="fas fa-circle modifier-icon"></i>
                                                    <?php if($modifier['quantity'] > 1): ?>
                                                        <strong><?php echo e($modifier['quantity']); ?>×</strong>
                                                    <?php endif; ?>
                                                    <?php echo e($modifier['name']); ?>

                                                    <?php if($modifier['category']): ?>
                                                        <span style="color: #707070; font-size: 14px;">(<?php echo e($modifier['category']); ?>)</span>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                        ...
                        <?php if(count($order['notes']) > 0): ?>
                            <div class="order-notes">
                                ...
                                <?php $__currentLoopData = $order['notes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="order-note"><?php echo e($note['note']); ?></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php endif; ?>

                        <!-- Status Change Buttons -->
                        <?php if($canChangeStatus ?? true): ?>
                        <div class="order-status-buttons">
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($status['status_id'] != $order['status_id']): ?>
                                    <button 
                                        class="status-btn status-<?php echo e(strtolower($status['status_name'])); ?>"
                                        onclick="updateOrderStatus(<?php echo e($order['order_id']); ?>, <?php echo e($status['status_id']); ?>, '<?php echo e($status['status_name']); ?>')">
                                        <?php if(strtolower($status['status_name']) === 'cancel'): ?>
                                            <i class="fas fa-times"></i> <?php echo e($status['status_name']); ?>
    ...
    <script>
        ...
        const currentStationSlug = '<?php echo e(isset($station) && $station ? $station->slug : ""); ?>';
        const currentStationName = '<?php echo e(isset($station) && $station ? $station->name : "Kitchen"); ?>';
        const canChangeStatus = <?php echo e(($canChangeStatus ?? true) ? 'true' : 'false'); ?>;
        const refreshInterval = <?php echo e($refreshInterval ?? 5); ?> * 1000; // Convert to milliseconds
        ...
        let previousOrderCount = <?php echo e(count($orders)); ?>;
        let previousOrderIds = new Set([<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($order['order_id']); ?><?php echo e(!$loop->last ? ',' : ''); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]);
        let audioContext = null;
        let audioContextInitialized = false;
        const selectedSound = '<?php echo e($kdsNotificationSound ?? "doorbell"); ?>';
        ...
        function changeStation(stationSlug) {
            if (stationSlug) {
                window.location.href = '<?php echo e(admin_url("kitchendisplay")); ?>/' + stationSlug;
            } else {
                window.location.href = '<?php echo e(admin_url("kitchendisplay")); ?>';
            }
        }
        ...
        async function refreshOrders() {
            ...
            try {
                const refreshUrl = '<?php echo e(admin_url("kitchendisplay/index")); ?>';
        ...
        async function updateOrderStatus(orderId, statusId, statusName) {
            ...
            try {
                const updateUrl = '<?php echo e(admin_url("kitchendisplay/index")); ?>';
...
<?php /**PATH /var/www/paymydine/app/admin/views/kitchendisplay/index.blade.php ENDPATH**/ ?>