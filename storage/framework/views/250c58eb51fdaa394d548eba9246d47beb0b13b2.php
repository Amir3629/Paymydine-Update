...
<div class="row-fluid">
    ...
    <input type="hidden" name="order_id" id="existing-order-id" value="<?php echo e($existingOrder->order_id ?? ''); ?>">
    <input type="hidden" name="table_id" id="selected-table" value="<?php echo e($existingOrder->table_id ?? ''); ?>">
    ...
    <input type="hidden" name="payment_method" id="payment-method-input" value="<?php echo e($existingOrder->payment ?? 'cod'); ?>">
    ...
    <div class="table-selection">
        ...
        <div class="table-grid-container" id="table-grid">
            ...
            <div class="table-grid">
                <!-- Cashier -->
                <div class="table-item cashier-option" data-value="Cashier" id="cashierButton" data-url="<?php echo e($cashierUrl); ?>">
...
<?php $name = strtolower(is_array($row ?? null) ? ($row["table_name"] ?? "") : ($row->table_name ?? "")); ?>
<?php
  $isCashier = ($row->table_no === 0) || (strtolower($row->table_name) === 'cashier');
?>
<?php if($isCashier) continue; ?>
                <?php 
                    ...
                    <div class="table-item <?php echo $isUnavailable ? 'unavailable' : 'available'; ?>" 
                         data-value="<?php echo e($row->table_name); ?>_<?php echo e($row->table_id); ?>"
                     data-table-id="<?php echo e($row->table_id); ?>"
                     data-table-no="<?php echo e($row->table_no); ?>"
                         data-capacity="<?php echo e($row->min_capacity); ?>-<?php echo e($row->max_capacity); ?>"
                         data-status="<?php echo e($statusClass); ?>"
                         title="Click to open frontend menu for <?php echo e($row->table_name); ?>"
                         style="position: absolute; left: <?php echo e(rand(50, 800)); ?>px; top: <?php echo e(rand(100, 600)); ?>px;">
                        <div class="table-circle <?php echo $statusClass; ?>">
                            <span class="table-number"><?php echo e($row->table_name); ?></span>
                            <span class="table-capacity"><?php echo e($row->min_capacity); ?>-<?php echo e($row->max_capacity); ?></span>
                        ...
                        <div class="table-status"><?php echo e($tableStatus); ?></div>
                </div>
    ...
    <div class="row w-100">
        <div class="col">
                ...
                <div class="category-buttons">
                    ...
                    <?php if($categories->isNotEmpty()): ?>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" class="category-btn" data-category="<?php echo e($category->category_id); ?>">
                                <i class="fa fa-utensils"></i> <?php echo e($category->name); ?>

                            </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <?php if($comboData->isNotEmpty()): ?>
            ...
            <div class="menu-selection-container">
                ...
                <?php $__currentLoopData = $menuData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                ?>
                    <div class="interactive-card <?php echo e($isStockOut ? 'stock-out disabled' : ''); ?>" 
                     data-id="<?php echo e($menuRow->menu_id); ?>" 
                     data-price="<?php echo e($menuRow->menu_price); ?>" 
                    data-image="<?php echo e($menuImage); ?>"
                     data-name="<?php echo e($menuRow->menu_name); ?>" 
                     data-options='<?php echo e($menuOptionsJson); ?>'
                     data-categories='<?php echo e($menuCategoriesJson); ?>'
                     data-category-names='<?php echo e(json_encode($menuRow->categories->pluck('name')->toArray())); ?>'
                     data-quantity="0"
                     data-stock-out="<?php echo e($isStockOut ? '1' : '0'); ?>"
                    >
                    ...
                    <div class="card-front">
                        <div class="menu-image-container">
                            <img src="<?php echo e($menuImage); ?>" alt="<?php echo e($menuRow->menu_name); ?>" class="menu-image">
                            <?php if($isStockOut): ?>
                        ...
                        <div class="menu-info">
                            <span class="menu-name"><?php echo e($menuRow->menu_name); ?></span>
                            <span class="menu-price"><?php echo e($menuRow->menu_price); ?><?php echo e(app('currency')->getDefault()->currency_symbol); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="card-back force-white-background">
                        <div class="back-header">
                            <h4><?php echo e($menuRow->menu_name); ?> Options</h4>
                        </div>
                ...
                <!-- Combo Meals -->
                <?php $__currentLoopData = $comboData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comboRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                ?>
                    <div class="interactive-card combo-item" 
                     data-id="combo_<?php echo e($comboRow->combo_id); ?>" 
                     data-price="<?php echo e($comboRow->combo_price); ?>" 
                    data-image="<?php echo e($comboImage); ?>"
                     data-name="<?php echo e($comboRow->combo_name); ?>" 
                     data-combo-id="<?php echo e($comboRow->combo_id); ?>"
                     data-is-combo="true"
                     data-quantity="0"
                    >
                    <!-- Quantity Badge - Outside card structure -->
                    ...
                    <div class="card-front">
                        <div class="menu-image-container">
                            <img src="<?php echo e($comboImage); ?>" alt="<?php echo e($comboRow->combo_name); ?>" class="menu-image">
                            <div class="combo-badge">COMBO</div>
                        </div>
                        <div class="menu-info">
                            <span class="menu-name"><?php echo e($comboRow->combo_name); ?></span>
                            <span class="menu-price"><?php echo e($comboRow->combo_price); ?><?php echo e(app('currency')->getDefault()->currency_symbol); ?></span>
                            <?php if($comboItems): ?>
                            <span class="combo-items-text" style="font-size: 11px; color: #666; margin-top: 4px; display: block;">
                                <?php echo e($comboItems); ?>
                    ...
                    <div class="card-back force-white-background">
                        <div class="back-header">
                            <h4><?php echo e($comboRow->combo_name); ?></h4>
                        </div>
                        <div class="options-content">
                            <div class="combo-details">
                                <p><strong>Includes:</strong></p>
                                <ul style="list-style: none; padding: 0; margin: 10px 0;">
                                    <?php $__currentLoopData = $comboRow->combo_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li style="padding: 5px 0;">
                                            <?php echo e($item->menu ? $item->menu->menu_name : 'Unknown'); ?>

                                            <?php if($item->quantity > 1): ?>
                                                <span style="color: #666;">(x<?php echo e($item->quantity); ?>)</span>
                                            <?php endif; ?>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                                <?php if($comboRow->combo_description): ?>
                                <p style="margin-top: 10px; font-size: 12px; color: #666;">
                                    <?php echo e($comboRow->combo_description); ?>
                ...
                <p class="empty-cart-text">No items selected yet</p>
                    ...
                    <div class="payment-method-section" id="payment-method-section" style="display: none;">
                        ...
                        <div class="payment-methods-grid" id="payment-methods-grid">
                            ...
                            <?php if(isset($paymentMethods) && $paymentMethods->count() > 0): ?>
                                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="payment-method-option">
                                        <input type="radio" name="payment_method_radio" value="<?php echo e($method->code); ?>" 
                                               <?php echo e((($existingOrder->payment ?? 'cod') === $method->code || (!isset($existingOrder) && $method->code === 'cod')) ? 'checked' : ''); ?>>
                                        <span class="payment-method-label"><?php echo e($method->name); ?></span>
                                    </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                <label class="payment-method-option">
                            ...
                            <?php endif; ?>
                            <?php if(!$hasQrPayLaterMethod): ?>
                                <label class="payment-method-option">
                                    <input type="radio" name="payment_method_radio" value="qr_pay_later"
                                           <?php echo e(($existingOrder->payment ?? '') === 'qr_pay_later' ? 'checked' : ''); ?>>
...
document.addEventListener("DOMContentLoaded", function () {
        ...
        const placeOrderBtn = document.getElementById("place-order-btn");
            ...
            <?php if(isset($existingOrder) && $existingOrder && isset($existingOrderItems) && count($existingOrderItems) > 0): ?>
            // Pre-populate cart with existing order items
            const existingOrderItems = <?php echo json_encode($existingOrderItems, 15, 512) ?>;
            const existingOrderId = <?php echo e($existingOrder->order_id); ?>;
            const existingTableId = <?php echo e($existingOrder->table_id ?? 'null'); ?>;
            const existingTableName = '<?php echo e($existingOrder->order_type ?? ""); ?>';
    ...
    menuItems.forEach(item => {
            ...
            const taxSettings = {
                enabled: <?php echo e(isset($taxSettings['enabled']) && $taxSettings['enabled'] ? 'true' : 'false'); ?>,
                percentage: <?php echo e($taxSettings['percentage'] ?? 0); ?>,
                menuPrice: <?php echo e($taxSettings['menuPrice'] ?? 1); ?>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    (function () {
        ...
        if (!btn) return;
        console.log('cashier table ID = <?php echo e($cashierTableId ?? "not found"); ?>');
        console.log('cashier URL = <?php echo e($cashierUrl); ?>');
    ...
    document.getElementById('back-to-tables').addEventListener('click', function() {
        ...
        if (buttonText.includes('Back to Order')) {
            window.location.href = '<?php echo e(admin_url('orders')); ?>';
        } else {
...
<?php /**PATH /var/www/paymydine/app/admin/views/orders/create.blade.php ENDPATH**/ ?>