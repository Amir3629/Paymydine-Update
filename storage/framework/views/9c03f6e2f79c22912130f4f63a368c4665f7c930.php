<?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
    <tr id="<?php echo e($rowId); ?>" 
        data-status-name="<?php echo e(strtolower($statusName)); ?>" 
        data-is-history="<?php echo e($isHistory ? '1' : '0'); ?>"
        class="order-row <?php echo e($isHistory ? 'history-order' : 'active-order'); ?>"
        style="background-color: <?php echo e($lightBackground); ?>; transition: all 0.3s ease, opacity 0.3s ease, transform 0.3s ease;" 
...
<?php /**PATH /var/www/paymydine/app/admin/views/orders/lists/list_body.blade.php ENDPATH**/ ?>