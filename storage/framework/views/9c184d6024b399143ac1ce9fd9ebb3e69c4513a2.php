                        ...
                        <div class="pos-info-column" style="display: block !important; visibility: visible !important; opacity: 1 !important; width: 100% !important;">
                            ...
                            <?php if(isset($fields['order_details'])): ?>
                                        <div style="margin-bottom: 24px; padding-bottom: 24px; border-bottom: 2px solid #e5e9f2;">
                                            <h6 class="card-title mb-3" style="font-size: 14px; font-weight: 700; color: #364a63;"><?php echo app('translator')->get($fields['order_details']->label ?? 'admin::lang.orders.label_invoice'); ?></h6>
                                    ...
                                    <?php if(isset($fields['location'])): ?>
                                        <div style="margin-bottom: 0;">
                                            <h6 class="card-title mb-3" style="font-size: 14px; font-weight: 700; color: #364a63;"><?php echo app('translator')->get($fields['location']->label); ?></h6>
                            ...
                            <?php if($formModel->comment): ?>
                                <div class="card bg-light shadow-sm pos-comment-card">
                                    <div class="card-body p-3">
                                        <h6 class="card-title mb-2"><?php echo app('translator')->get('admin::lang.orders.label_comment'); ?></h6>
                            ...
                            <?php if($formModel->delivery_comment): ?>
                                <div class="card bg-light shadow-sm pos-comment-card">
                                    <div class="card-body p-3">
                                        <h6 class="card-title mb-2"><?php echo app('translator')->get('admin::lang.orders.label_delivery_comment'); ?></h6>
...
<?php /**PATH /var/www/paymydine/app/admin/views/orders/form/form_tabs.blade.php ENDPATH**/ ?>