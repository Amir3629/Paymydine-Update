...
(function () {
 ...
 /* ===== END MOBILE HEADER HIDE UNTIL STABLE ===== */
    ...
    <link rel="stylesheet" href="<?php echo e(asset('app/admin/assets/css/pmd-mediamanager-autofix.css')); ?>?v=<?php echo e(time()); ?>">
    
    <link rel="stylesheet" href="<?php echo e(asset('app/admin/assets/css/pmd-admin/components/toolbar-buttons.css')); ?>?v=<?php echo e(time()); ?>">
</head>
<script>
...
<!-- PMD EARLY SORTABLE DROPZONE START -->
    <script src="<?php echo e(asset('app/admin/assets/vendor/pmd-mediafix/Sortable.min.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <script src="<?php echo e(asset('app/admin/assets/vendor/pmd-mediafix/dropzone.min.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
(function () {
  ...
  if (window.XMLHttpRequest) {
    ...
    <script src="<?php echo e(asset('app/admin/assets/js/pmd-mediafinder-autofix.js')); ?>?v=<?php echo e(time()); ?>"></script>
</body>
</html>
