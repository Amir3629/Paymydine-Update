...
#<?php echo e($field->getId('group') ?? 'order-info-container'); ?>,
...
<div class="order-info-header">
    ...
    <div class="order-info-item table-number">
        ...
        <div class="order-info-value"><?php echo e($formModel->order_type_name ?: 'N/A'); ?></div>
    </div>
    ...
    <div class="order-info-item order-id">
        ...
        <div class="order-info-value order-id-value">#<?php echo e($formModel->order_id); ?></div>
    </div>
    ...
    <div class="order-info-item status">
        ...
        <a
            ...
            data-status-color="<?php echo e($formModel->status && $formModel->status->status_color ? $formModel->status->status_color : '#364a63'); ?>"
        ...
        >
            <?php if($formModel->status): ?>
                <i class="fa fa-circle status-dot-icon" style="font-size: 8px; color: <?php echo e($formModel->status->status_color ?? '#364a63'); ?> !important;"></i>
                <?php echo e($formModel->status->status_name); ?>
    ...
    <div class="order-info-item assignee">
        ...
        >
            <?php if($formModel->assignee): ?>
                <?php echo e($formModel->assignee->staff_name); ?>
...
: admin_url('orders/invoice/'.$formModel->order_id)); ?>"
            ...
            <a
                class="invoice-icon-btn"
                href="<?php echo e(preg_match('/invoice_id=([0-9]+)/', (string)($formModel->comment ?? ''), $__pmdBon) ? admin_url('orders/pos-bon/'.$formModel->order_id).'?invoice_id='.($__pmdBon[1] ?? '') : admin_url('orders/pos-invoice/'.$formModel->order_id)); ?>"
                target="_blank"
...
<?php /**PATH /var/www/paymydine/app/admin/views/orders/form/info.blade.php ENDPATH**/ ?>