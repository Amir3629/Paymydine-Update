<div class="customer-card-content" data-order-id="<?php echo e($formModel->order_id); ?>" data-edit-url="<?php echo e(admin_url('orders/edit/')); ?>" style="width: 100%;">
    <h6 class="customer-card-title" style="font-size: 14px; font-weight: 700; margin-bottom: 8px;"><?php echo app('translator')->get($field->label); ?></h6>
    <div class="customer-info" style="font-size: 13px; padding-bottom: 6px;">
        <?php if($formModel->customer): ?>
            <a href="<?php echo e(admin_url('customers/preview/'.$formModel->customer_id)); ?>" style="font-weight: normal; color: #364a63;"><?php echo e($formModel->customer_name); ?></a>
        <?php else: ?>
            <span style="font-weight: normal; color: #364a63;"><?php echo e($formModel->customer_name); ?></span>
        <?php endif; ?>
    </div>
    ...
    <div class="customer-info editable-field" style="font-size: 13px; padding-bottom: 6px; color: #526484; position: relative;">
        <div class="editable-display">
            ...
            <span class="editable-value" data-field="email"><?php echo e($formModel->email); ?></span>
        ...
        <div class="editable-edit" style="display: none;">
            <input type="email" class="form-control form-control-sm editable-input" value="<?php echo e($formModel->email); ?>" data-field="email" data-order-id="<?php echo e($formModel->order_id); ?>" style="font-size: 12px; padding: 2px 5px; height: 24px;">
    ...
    <?php if($formModel->telephone || true): ?>
        <div class="customer-info editable-field" style="font-size: 13px; padding-bottom: 6px; color: #526484; position: relative;">
            <div class="editable-display">
                <i class="fa fa-phone fa-fw text-muted" style="font-size: 12px;"></i>&nbsp;
                <span class="editable-value" data-field="telephone"><?php echo e($formModel->telephone ?: 'N/A'); ?></span>
            ...
            <div class="editable-edit" style="display: none;">
                <input type="text" class="form-control form-control-sm editable-input" value="<?php echo e($formModel->telephone); ?>" data-field="telephone" data-order-id="<?php echo e($formModel->order_id); ?>" style="font-size: 12px; padding: 2px 5px; height: 24px;">
                <button type="button" class="btn-save-inline" onclick="return handleSaveField(this);" style="background: #364a63; color: white; border: none; padding: 1px 4px; font-size: 9px; cursor: pointer; margin-left: 4px; border-radius: 3px; width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; vertical-align: middle;" title="Save">
                    <i class="fa fa-check" style="font-size: 8px;"></i>
                </button>
                <button type="button" class="btn-cancel-inline" onclick="return handleCancelEdit(this);" style="background: #dc3545; color: white; border: none; padding: 1px 4px; font-size: 9px; cursor: pointer; margin-left: 2px; border-radius: 3px; width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; vertical-align: middle;" title="Cancel">
    ...
    <?php if($formModel->isDeliveryType() && $formModel->address): ?>
        <div class="customer-info" style="font-size: 13px; padding-top: 8px; border-top: 1px solid #f5f6fa; margin-top: 8px;">
            <h6 style="font-size: 13px; font-weight: 600; margin-bottom: 4px; color: #526484;"><?php echo app('translator')->get('admin::lang.orders.label_delivery_address'); ?></h6>
...
<?php /**PATH /var/www/paymydine/app/admin/views/orders/form/field_customer.blade.php ENDPATH**/ ?>