    ...
    <div class="progress mb-3" style="height: 25px;">
        <?php $__currentLoopData = $cacheSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cacheInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div
                ...
                data-cache-label="<?php echo e($cacheInfo->label); ?>"
                data-cache-size="<?php echo e($cacheInfo->formattedSize); ?>"
...
(function() {
    ...
    function initializeCacheDonutChart() {
        const cacheWidget = document.getElementById('<?php echo e($this->getId()); ?>');
        ...
        progressBars.forEach((bar) => {
            ...
            const color = bar.style.backgroundColor || bar.getAttribute('style').match(/background-color:\s*([^;]+)/)?.[1] || '#ccc';
        ...
        const separationDistance = 10; // pixels to move each slice outward (slightly more for 3 slices)
...
<?php /**PATH /Users/amir/Downloads/paymydine-main-9/app/system/dashboardwidgets/cache/cache.blade.php ENDPATH**/ ?>