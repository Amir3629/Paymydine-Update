    ...
    <nav class="navbar navbar-top navbar-expand navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-brand" style="height:63px;">
                <a class="logo" href="<?php echo e(admin_url('dashboard')); ?>" style="margin-left: 28px; margin-top: 12px;">
                    <?php if(!empty($imgSrcDashboard)): ?>
                        <img src="<?php echo e($imgSrcDashboard); ?>?t=<?php echo e(time()); ?>" alt="Dashboard Logo" style="max-height: 105px; max-width: 400px; object-fit: contain;">
                    <?php endif; ?>
                    <i class="logo-svg"></i>
                </a>
            </div>
            ...
            <div class="navbar navbar-right">
                ...
                <?php if(isset($this->widgets['mainmenu'])): ?>
...
<?php /**PATH /var/www/paymydine/app/admin/views/_partials/top_nav.blade.php ENDPATH**/ ?>