...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <button type="button" id="back-to-tables" class="btn btn-primary" style="display: none;" onclick="window.location.href='<?php echo e(admin_url('orders')); ?>'">
...
<?php /**PATH /Users/amir/Downloads/paymydine-main-9/app/admin/views/orders/create.blade.php ENDPATH**/ ?>