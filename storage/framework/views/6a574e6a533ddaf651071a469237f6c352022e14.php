...
<head>
    ...
    <!-- Page Title  -->
    <title>Login | <?php echo e(setting('site_name')); ?></title>
     <!-- StyleSheets  -->
...
<body class="nk-body bg-white npc-general pg-auth">
                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="<?php echo e(admin_url('dashboard')); ?>" class="logo-link">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h5 class="nk-block-title"><?php echo app('translator')->get('admin::lang.login.text_title'); ?></h5>
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <label class="form-label" for="input-username"><?php echo app('translator')->get('admin::lang.login.label_username'); ?></label>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <label class="form-label" for="input-password"><?php echo app('translator')->get('admin::lang.login.label_password'); ?></label>
                                    </div>
                                    <div class="form-control-wrap">
                                ...
                                <div class="form-group">
                                    <p class="text-right">
                                        <a href="<?php echo e(admin_url('login/reset')); ?>" style="color: #364a63 !important;">
    ...
    <script src="<?php echo e(asset('app/admin/assets/js/admin.js')); ?>"></script>
...
<?php /**PATH /var/www/paymydine/app/admin/views/auth/login_standalone.blade.php ENDPATH**/ ?>