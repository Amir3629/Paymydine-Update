                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="site">
                                                <div class="card-inner pt-0">
                                                    ...
                                                    <form action="<?php echo e(url('/superadmin/settings/update')); ?>" method="POST" class="gy-3 form-settings">
                                                    <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="company_name" class="form-control" id="comp-name" value="<?php echo e(old('company_name', $superadmin->company_name)); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row g-3 align-center">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="email"  class="form-control" id="comp-email"value="<?php echo e(old('email', $superadmin->email)); ?>" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row g-3 align-center">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="company_website" class="form-control" name="site-url"  value="<?php echo e(old('company_website', $superadmin->company_website)); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
</html><?php /**PATH /Users/amir/Downloads/paymydine-main/app/admin/views/settings.blade.php ENDPATH**/ ?>