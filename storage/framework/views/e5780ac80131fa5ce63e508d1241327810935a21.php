...
<?php endif; ?>
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                <div class="user-avatar bg-primary">
                                                                    <span>T <?php echo e($tenant->id); ?></span>
                                                                </div>
                                                                <div class="user-info">
                                                        ...
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li class="nk-tb-action-hidden">
                                                                    <a  href="mailto:<?php echo e($tenant->email); ?>" class="btn btn-trigger btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Send Email">
    ...
    <a href="javascript:void(0);" 
        ...
        title="<?php echo e($isActive ? 'Disable Restaurant' : 'Activate Restaurant'); ?>">
   ...
   data-url="<?php echo e(url('/tenants/delete/' . $tenant->id)); ?>">
    ...
    <span>Delete Restaurant</span>
                                                                                ...
                                                                                <li><a data-bs-toggle="modal"  data-id="<?php echo e($tenant->id); ?>" 
...
<?php /**PATH /Users/amir/Downloads/paymydine-main-9/app/admin/views/new.blade.php ENDPATH**/ ?>