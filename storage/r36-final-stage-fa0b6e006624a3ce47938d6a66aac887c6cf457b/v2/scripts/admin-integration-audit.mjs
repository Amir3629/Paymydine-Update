...
if (!failures.length) {
  ...
  if (!route.includes("'/api/v1/frontend-theme-v2'")) failures.push('V2 theme route endpoint missing')
  ...
  if (!installer.includes("__DIR__.'/theme-settings.php'")) failures.push('Installer does not preserve legacy theme route ordering')
