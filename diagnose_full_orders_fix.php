...
$statusHistoryTable = "ti_status_history";
$paymentAttemptsTable = "ti_payment_attempts";
$noteHistoryTable = "ti_note_history";
...
foreach ($lastPayments as $payment) {
    ...
    // بررسی ستون‌ها برای جدول‌های تاریخچه
    $historyTables = [
        "Status History" => $statusHistoryTable,
        "Payment Attempts" => $paymentAttemptsTable,
        "Note History" => $noteHistoryTable
    ];
...
echo "\n=== پایان بررسی کامل با ستون‌های واقعی ===\n";
