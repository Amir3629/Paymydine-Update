...
Windows connector generated by admin UI already sets:
- install path: `C:\ProgramData\PayMyDine\LocalPosAgent`
- log file: `C:\ProgramData\PayMyDine\LocalPosAgent\agent.log`
