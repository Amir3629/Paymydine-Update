...
-- Generated UTC: Fri Sep 11 10:34:33 UTC 2026
...
CREATE TABLE `ti_categories` (
  ...
  `pmd_kind` varchar(24) NOT NULL DEFAULT 'regular',
...
CREATE TABLE `ti_kds_stations` (
  ...
  `reservation_window_minutes` int(11) NOT NULL DEFAULT 90,
  `ready_pickup_timeout_minutes` int(11) NOT NULL DEFAULT 8,
  `auto_hide_completed_minutes` int(11) NOT NULL DEFAULT 5,
  `order_limit` int(11) NOT NULL DEFAULT 150,
  ...
  KEY `pmd_kds_stations_slug_active_v83` (`slug`,`is_active`),
  KEY `pmd_kds_stations_slug_active_v46` (`slug`,`is_active`),
  KEY `pmd_kds_stations_active_priority_v46` (`is_active`,`priority`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ti_menu_categories` (
  ...
  KEY `pmd_kds_menu_categories_menu_v83` (`menu_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ti_order_menu_options` (
  ...
  KEY `pmd_kds_order_options_order_menu_v83` (`order_menu_id`,`order_menu_option_id`),
  KEY `pmd_kds_order_options_order_v83` (`order_id`,`order_menu_id`)
...
CREATE TABLE `ti_order_menus` (
  ...
  KEY `pmd_kds_order_menus_order_v83` (`order_id`,`order_menu_id`)
...
DROP TABLE IF EXISTS `ti_pmd_reservation_preferences`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_reservation_preferences` (
...
--
-- Table structure for table `ti_pmd_staff_chat_group_members`
--

DROP TABLE IF EXISTS `ti_pmd_staff_chat_group_members`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_staff_chat_group_members` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pmd_staff_chat_group_member_unique` (`group_id`,`staff_id`),
  KEY `pmd_staff_chat_member_staff_group_idx` (`staff_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ti_pmd_staff_chat_groups`
--

DROP TABLE IF EXISTS `ti_pmd_staff_chat_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_staff_chat_groups` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `location_id` bigint(20) unsigned NOT NULL,
  `name` varchar(96) NOT NULL,
  `group_type` varchar(24) NOT NULL DEFAULT 'custom',
  `created_by_staff_id` bigint(20) unsigned DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pmd_staff_chat_groups_location_active_idx` (`location_id`,`is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ti_pmd_staff_chat_messages`
--

DROP TABLE IF EXISTS `ti_pmd_staff_chat_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_staff_chat_messages` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `location_id` bigint(20) unsigned NOT NULL,
  `group_id` bigint(20) unsigned NOT NULL,
  `staff_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pmd_staff_chat_messages_group_created_idx` (`group_id`,`created_at`),
  KEY `pmd_staff_chat_messages_location_created_idx` (`location_id`,`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `ti_pmd_waiter_seed_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_waiter_seed_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `staff_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ti_pmd_waiter_seed_log_staff_id_index` (`staff_id`),
  KEY `ti_pmd_waiter_seed_log_user_id_index` (`user_id`),
  KEY `ti_pmd_waiter_seed_log_table_id_index` (`table_id`),
  KEY `ti_pmd_waiter_seed_log_order_id_index` (`order_id`),
  KEY `ti_pmd_waiter_seed_log_order_menu_id_index` (`order_menu_id`),
  KEY `ti_pmd_waiter_seed_log_menu_id_index` (`menu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ti_pmd_waiter_table_assignments`
--

DROP TABLE IF EXISTS `ti_pmd_waiter_table_assignments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_waiter_table_assignments` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pmd_waiter_table_unique_v85` (`staff_id`,`table_id`,`is_active`),
  KEY `ti_pmd_waiter_table_assignments_staff_id_index` (`staff_id`),
  KEY `ti_pmd_waiter_table_assignments_table_id_index` (`table_id`),
  KEY `ti_pmd_waiter_table_assignments_location_id_index` (`location_id`),
  KEY `ti_pmd_waiter_table_assignments_is_active_index` (`is_active`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ti_statuses` (
  ...
  KEY `pmd_kds_statuses_for_name_v83` (`status_for`,`status_name`)
...
CREATE TABLE `ti_tables` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `qr_code` varchar(30) DEFAULT NULL,
  `floor_x` decimal(8,2) DEFAULT NULL,
  `floor_y` decimal(8,2) DEFAULT NULL,
  `floor_width` decimal(8,2) DEFAULT NULL,
  `floor_height` decimal(8,2) DEFAULT NULL,
  `floor_shape` varchar(40) DEFAULT 'rectangle',
  `table_section` varchar(120) DEFAULT NULL,
  `preferred_capacity` int(11) DEFAULT NULL,
  `table_features` text DEFAULT NULL,
  `floor_notes` text DEFAULT NULL,
  `reservable` tinyint(1) NOT NULL DEFAULT 1,
  `reservation_priority` int(11) NOT NULL DEFAULT 0,
  `visible_on_floor_plan` tinyint(1) NOT NULL DEFAULT 1,
...
-- Dump completed on 2026-09-11 10:34:34
...
CREATE TABLE `ti_kds_stations` (
  ...
  `ready_pickup_timeout_minutes` int(11) NOT NULL DEFAULT 8,
  `auto_hide_completed_minutes` int(11) NOT NULL DEFAULT 5,
  `order_limit` int(11) NOT NULL DEFAULT 50,
  `sort_order` int(11) NOT NULL DEFAULT 0,
  `location_id` int(10) unsigned DEFAULT NULL,
  `priority` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `ti_pmd_guest_payment_intents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_guest_payment_intents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(64) NOT NULL,
  `order_id` int(10) unsigned NOT NULL,
  `guest_session_id` varchar(191) DEFAULT NULL,
  `split_mode` varchar(24) NOT NULL,
  `split_people` int(10) unsigned DEFAULT NULL,
  `share_percent` decimal(8,3) DEFAULT NULL,
  `part_index` int(10) unsigned DEFAULT NULL,
  `plan_base_amount` decimal(15,4) NOT NULL DEFAULT 0.0000,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ti_pmd_guest_payment_intents_token_unique` (`token`),
  KEY `ti_pmd_guest_payment_intents_order_id_index` (`order_id`),
  KEY `ti_pmd_guest_payment_intents_guest_session_id_index` (`guest_session_id`),
  KEY `ti_pmd_guest_payment_intents_split_mode_index` (`split_mode`),
  KEY `ti_pmd_guest_payment_intents_status_index` (`status`),
...
CREATE TABLE `ti_pmd_table_status_history` (
  ...
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `ti_pmd_table_status_history_table_idx` (`table_id`),
  KEY `ti_pmd_table_status_history_status_idx` (`new_status`),
  KEY `ti_pmd_table_status_history_created_idx` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ti_pmd_waiter_pos_item_meta`
--

DROP TABLE IF EXISTS `ti_pmd_waiter_pos_item_meta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_waiter_pos_item_meta` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) unsigned NOT NULL,
  `order_menu_id` bigint(20) unsigned NOT NULL,
  `seat_no` int(10) unsigned DEFAULT NULL,
  `course_no` int(10) unsigned DEFAULT NULL,
  `course_status` varchar(20) NOT NULL DEFAULT 'held',
  `voided_quantity` decimal(12,3) NOT NULL DEFAULT 0.000,
  `void_reason` varchar(255) DEFAULT NULL,
  `updated_by` bigint(20) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ti_pmd_waiter_pos_item_meta_order_menu_id_unique` (`order_menu_id`),
  KEY `ti_pmd_waiter_pos_item_meta_order_id_index` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ti_pmd_waiter_pos_operation_logs`
--

DROP TABLE IF EXISTS `ti_pmd_waiter_pos_operation_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ti_pmd_waiter_pos_operation_logs` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ti_pmd_waiter_pos_operation_logs_order_id_index` (`order_id`),
  KEY `ti_pmd_waiter_pos_operation_logs_action_index` (`action`)
...
CREATE TABLE `ti_tables` (
  ...
  `table_section` varchar(191) DEFAULT NULL,
  `floor_x` decimal(10,2) DEFAULT NULL,
  `floor_y` decimal(10,2) DEFAULT NULL,
  `floor_width` decimal(10,2) DEFAULT NULL,
  `floor_height` decimal(10,2) DEFAULT NULL,
  `floor_shape` varchar(50) DEFAULT NULL,
  `table_features` text DEFAULT NULL,
  `reservable` tinyint(1) DEFAULT 1,
  `reservation_priority` int(11) DEFAULT NULL,
  `visible_on_floor_plan` tinyint(1) DEFAULT 1,
  `floor_notes` text DEFAULT NULL,
  `operational_status` varchar(32) NOT NULL DEFAULT 'available',
  `operational_status_updated_at` datetime DEFAULT NULL,
  `operational_status_updated_by` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`table_id`),
  UNIQUE KEY `idx_tables_table_no` (`table_no`),
...
-- Dump completed on 2026-09-11 10:34:35
...
CREATE TABLE `ti_order_payment_transaction_items` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `transaction_id` bigint(20) unsigned NOT NULL,
  `order_menu_id` bigint(20) unsigned DEFAULT NULL,
  `menu_id` bigint(20) unsigned DEFAULT NULL,
  `quantity_paid` decimal(10,3) NOT NULL,
  `unit_price` decimal(15,4) NOT NULL,
  `line_total` decimal(15,4) NOT NULL,
...
-- Dump completed on 2026-09-11 10:34:36
