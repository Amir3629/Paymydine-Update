...
-- Generated UTC: Tue Jun 16 21:52:47 UTC 2026
...
-- Dump completed on 2026-06-16 21:52:48
...
CREATE TABLE `ti_notifications` (
  ...
  KEY `idx_type` (`type`),
  KEY `idx_table_id` (`table_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1362 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ti_order_totals` (
  ...
  `is_summable` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`order_total_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5283 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-16 21:52:49
