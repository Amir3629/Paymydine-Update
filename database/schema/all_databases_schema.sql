...
-- Generated UTC: Sun May 24 01:06:16 UTC 2026
...
-- Dump completed on 2026-05-24  1:06:17
...
CREATE TABLE `ti_order_totals` (
  ...
  `is_summable` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`order_total_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3627 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
