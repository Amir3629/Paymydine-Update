...
$expect($personHours, 'SELECT 1 FROM ', 'harmless physical relation probe');
$expect($personHours, 'LIMIT 0', 'zero-row relation verification');
$expect($personHours, 'isMissingRelation(', '42S02 candidate fallback');
