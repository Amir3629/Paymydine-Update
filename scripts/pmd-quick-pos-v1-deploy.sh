...
grep -q "PMD_QPOS_TRANSFER_V24" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
...
grep -q "pmd-quick-pos-v1.js?v=20260920-24" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "pmd-quick-pos-v1.css?v=20260920-24" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
