...
FILES=(
  ...
  "app/admin/assets/js/pmd-menu-manager-v130.js"
...
if command -v node >/dev/null 2>&1; then
  node --check "$STAGE/app/admin/assets/js/pmd-menu-manager-v130.js"
  node --check "$STAGE/app/admin/assets/js/pmd-dashboard-lab-exact-floor-v1.js"
  node --check "$STAGE/app/admin/assets/js/pmd-shared-floor-multi-floor-v1.js"
...
grep -q "PMD_QPOS_KEYPAD_PAYMENT_ACTION_V21" "$STAGE/app/admin/assets/js/pmd-quick-pos-v1.js"
grep -q "PMD_QPOS_KEYPAD_PAYMENT_ACTION_V21" "$STAGE/app/admin/assets/css/pmd-quick-pos-v1.css"
grep -q "PMD_QPOS_WORKSPACE_TOAST_CLEAN_V22" "$STAGE/app/admin/assets/js/pmd-quick-pos-v1.js"
grep -q "PMD_QPOS_PAYMENT_FILL_V23" "$STAGE/app/admin/assets/js/pmd-quick-pos-v1.js"
grep -q "PMD_QPOS_PAYMENT_FILL_V23" "$STAGE/app/admin/assets/css/pmd-quick-pos-v1.css"
grep -q "PMD_MENU_NUMBER_V24" "$STAGE/app/admin/controllers/concerns/PmdWaiterPosMenuCatalogV26Concern.php"
grep -q "PMD_MENU_MANAGER_NUMBER_V24" "$STAGE/app/admin/controllers/Pmdmenus.php"
grep -q "PMD_MENU_CARD_NUMBER_V24" "$STAGE/app/admin/views/pmdmenus/index.blade.php"
grep -q "PMD_MENU_CARD_NUMBER_V24" "$STAGE/app/admin/assets/css/pmd-menu-manager-v129.css"
grep -q "PMD_MENU_LIVE_NUMBER_V24" "$STAGE/app/admin/assets/js/pmd-menu-manager-v130.js"
grep -q "PMD_QPOS_TRANSFER_V24" "$STAGE/app/admin/controllers/PmdQuickPosV1.php"
grep -q "PMD_QPOS_TRANSFER_V24" "$STAGE/routes/admin-quick-mode.php"
grep -q "PMD_QPOS_TRANSFER_V25" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "PMD_QPOS_TRANSFER_UI_V24" "$STAGE/app/admin/assets/js/pmd-quick-pos-v1.js"
...
grep -q 'data-pmd-r2-tool="zoom-out"' "$STAGE/app/admin/views/_partials/pmd_dashboard_lab_exact_floor_v1.blade.php"
grep -q 'data-pmd-r2-tool="zoom-in"' "$STAGE/app/admin/views/_partials/pmd_dashboard_lab_exact_floor_v1.blade.php"
...
grep -q "pmd-qpos-product-number" "$STAGE/app/admin/assets/js/pmd-quick-pos-v1.js"
...
grep -q "PMD_QPOS_HISTORY_NOTIFICATIONS_V15" "$STAGE/app/admin/controllers/PmdQuickPosV1.php"
...
grep -q "pmd-qpos-workspace-modal" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "data-qpos-history-from" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "data-qpos-history-to" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "data-qpos-history-detail" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "data-qpos-history-kind" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "data-qpos-history-preset" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
grep -q "pmd-qpos-history-v15" "$STAGE/app/admin/controllers/PmdQuickPosV1.php"
