...
$expect($store, "'storage_mode' => 'tenant_pinned_created_at_window'", 'tenant-pinned daily history mode');
...
$expect($store, '$this->db()->transaction', 'writes use pinned connection');
...
$expect($view, 'pmd-ai-nav-mark-v3', 'single bot nav mark override');
$expect($view, '-webkit-mask:', 'single-glyph bot mask');
$reject($view, "content: 'AI'", 'AI mini-card monogram retired');
