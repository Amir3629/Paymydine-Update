...
TIMEOUT = 20
UA = 'PayMyDine-admin-asset-404-repair-r1'
...
def main() -> int:
    if len(sys.argv) != 2:
        print('usage: pmd_admin_asset_404_repair_r1.py <paymydine-root>', file=sys.stderr)
        return 2
    ...
    print('PMD_ADMIN_ASSET_404_REPAIR_R1_OK')
    return 0
