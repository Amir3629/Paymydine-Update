...
# PMD_OMAN_ADMIN_AR_COMPLETE_DEPLOY_R10
# Usage: bash scripts/pmd-oman-admin-ar-r10-deploy.sh <immutable-commit-sha>
...
STAGE="/tmp/pmd-oman-admin-ar-r10-${STAMP}"
BACKUP="$HOME/pmd-backups/oman-admin-ar-r10-${STAMP}"
...
# Exact Git blobs for the reviewed R10 payload. en.php is downloaded only as
# the immutable audit authority; it is not reinstalled because R10 does not
# modify English.
...
echo "======================================================"
echo "OMAN ADMIN ARABIC R10 - STAGE + STRICT AUDIT"
echo "Commit: $SHA"
echo "======================================================"
...
echo
echo "[2/4] Strict staged Arabic catalogue audit"
...
echo
echo "[4/4] Live audit as www-data"
...
echo "======================================================"
echo "OMAN ADMIN ARABIC R10 INSTALLED"
