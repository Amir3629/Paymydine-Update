...
REMOTE_BRANCH="${REMOTE_BRANCH:-feat/quick-pos-card-shadow-v29}"
REF="origin/${REMOTE_BRANCH}"
STAMP="$(date +%Y%m%d_%H%M%S)"
STAGE="$(mktemp -d /tmp/pmd-qpos-shadow-v29.XXXXXX)"
BACKUP="$ROOT/storage/pmd-patch-backups/qpos-shadow-v29-$STAMP"
DEPLOY_COMPLETE=0
...
echo "=============================================================="
echo " PayMyDine QUICK POS PRODUCT SHADOW V29"
echo " Branch: $REF"
echo " Backup: $BACKUP"
echo "=============================================================="
...
grep -q "PMD_QPOS_PRODUCT_SHADOW_V29" "$STAGE/app/admin/assets/css/pmd-quick-pos-v1.css"
grep -q "0 -14px 24px -10px rgba(15,23,42,.42)" "$STAGE/app/admin/assets/css/pmd-quick-pos-v1.css"
grep -q "pmd-quick-pos-v1.css?v=20260920-29" "$STAGE/app/admin/views/pmd_quick_pos_v1.blade.php"
...
echo
echo "===== LIVE VERIFY ====="
grep -q "PMD_QPOS_PRODUCT_SHADOW_V29" "$ROOT/app/admin/assets/css/pmd-quick-pos-v1.css"
grep -q "pmd-quick-pos-v1.css?v=20260920-29" "$ROOT/app/admin/views/pmd_quick_pos_v1.blade.php"

DEPLOY_COMPLETE=1

echo
echo "=============================================================="
echo " QUICK POS PRODUCT SHADOW V29 DEPLOY COMPLETE"
echo " Backup: $BACKUP"
echo " Only CSS + Quick POS view changed."
echo " JS, ordering, payments and performance stack were not replaced."
echo "=============================================================="
