...
// PMD_QPOS_ADMIN_AUTH_MIDDLEWARE_V53
// Direct Laravel controller routes must hydrate/verify the Admin session before
// Quick POS endpoint code runs.
Route::middleware(['web', 'AdminAuthenticate'])->group(function () {
    Route::get(
