...
class PosActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // PMD_ZCS_CUSTOMER_DISPLAY_V4
        // Customer display state is local to this physical POS device.
    ...
    private fun createCanonicalWebView() {
        ...
        val view = WebView(this).apply {
            ...
            // PMD_ZCS_CUSTOMER_DISPLAY_JS_BRIDGE_V4
            // Display-only bridge; card/payment authority remains outside this interface.
