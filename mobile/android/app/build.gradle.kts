...
android {
    ...
    defaultConfig {
        ...
        // PMD_ANDROID_0_3_35_V118_LOCAL_FIRST
        // V118 preserves exact selected-order append while Local-First transport stays durable.
        ...
        versionName = "0.3.37-v129-cloud-reentry" // PMD_ANDROID_0_3_28_RESPONSIVE_MATRIX_V102
...
val prepareCanonicalPosAssets by tasks.registering(Copy::class) {
    ...
    // PMD_ANDROID_V111_OFFLINE_UI_BUNDLE
    // PMD_ANDROID_V112_OFFLINE_WEB_PARITY_BUNDLE
