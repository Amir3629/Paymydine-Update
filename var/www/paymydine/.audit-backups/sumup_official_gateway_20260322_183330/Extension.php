...
class Extension extends BaseExtension
{
    ...
    {
        return [
            \Igniter\PayRegister\Payments\ApplePay::class => [
                'code' => 'apple_pay',
                'name' => 'Apple Pay',
                'description' => 'Stripe wallet (Apple Pay)',
            ],
            \Igniter\PayRegister\Payments\GooglePay::class => [
                'code' => 'google_pay',
                'name' => 'Google Pay',
                'description' => 'Stripe wallet (Google Pay)',
            ],
