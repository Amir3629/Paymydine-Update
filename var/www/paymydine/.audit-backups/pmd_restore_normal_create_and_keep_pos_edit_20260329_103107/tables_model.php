...
$config['form']['fields'] = [
    'table_no' => [
        'type' => 'text',
        'label'   => 'Table Number (Internal)',
        'type' => 'text',
        'span'    => 'left',
        'comment' => 'POS-synced tables show the external POS label here. For POS tables this field is display-only; native numeric logic stays internal.',
    ],
    'pos_table_label' => [
        ...
        'span' => 'left',
        'readOnly' => true,
        'comment' => 'Exact external/custom table label. This is the visible name we keep for POS-synced or custom-named tables.',
    ],
    'priority' => [
