...
(function() {
    ...
    function forceBlueButton(button) {
        // SKIP all toolbar primary buttons (Save, New, etc.) - force-button-alignment + CSS own them; avoid double hover
        if (button.closest && button.closest('.progress-indicator-container') && button.classList.contains('btn-primary')) {
            return false;
        }
        ...
        // SKIP media-finder blank-cover (image uploader plus card) – CSS controls it
        if (button.closest && button.closest('.media-finder') && (button.classList.contains('blank-cover') || button.classList.contains('find-button'))) {
            return false;
        }
        ...
        mutations.forEach(function(mutation) {
            ...
            if (mutation.type === 'attributes' && mutation.attributeName === 'style') {
                ...
                if (target.matches && target.matches('button, .btn, a.btn-primary, a.btn-success')) {
                    if (target.closest && target.closest('.progress-indicator-container') && target.classList.contains('btn-primary')) return;
