  ...
  const features = [
    {
      ...
      description: "Intuitive menu builder with visual drag-and-drop functionality"
    },
    {
      icon: Database,
      title: "Category Organization",
      description: "Organize your menu items into logical categories and subcategories"
    },
    {
      icon: Shield,
      title: "Allergen Management",
      description: "Comprehensive allergen tracking and customer safety features"
    },
    {
      icon: Zap,
      title: "Real-time Updates",
      description: "Instant menu updates across all platforms and devices"
    },
    {
      icon: Cloud,
      title: "Cloud Synchronization",
      description: "Automatic sync across all your restaurant locations"
    },
    {
      icon: Smartphone,
      title: "Mobile Optimization",
      description: "Perfect display on mobile devices and tablets"
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to create and manage your restaurant's menu efficiently
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the benefits of professional menu management
            </p>
          </div>
