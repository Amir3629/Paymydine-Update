...
class MultiTenantApiServer {
    ...
    public function __construct() {
        ...
        $this->mainDb = new PDO('mysql:host=127.0.0.1;dbname=paymydine', 'paymydine', 'CHANGE_THIS_STRONG_PASSWORD');
    ...
    private function detectTenant() {
        ...
        if ($subdomain && $subdomain !== 'www') {
            ...
            if ($this->tenantInfo) {
                ...
                $this->pdo = new PDO(
                    'mysql:host=127.0.0.1;dbname=' . $this->tenantInfo['database'], 'paymydine', 'CHANGE_THIS_STRONG_PASSWORD');
