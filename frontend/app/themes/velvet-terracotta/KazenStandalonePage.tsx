...
return (
    <main className="kazen-page velvet-page" data-pmd-theme-page="velvet-terracotta">
      ...
      <div className="kazen-shell">
        <header className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-end gap-3">
              ...
              <span className="kazen-stamp">VT</span>
            </div>
            <div className="kazen-brand">{state.restaurantName || "KAZEN"}</div>
            <div className="kazen-subtitle">Velvet Terracotta</div>
          </div>
        ...
        <section className="kazen-hero" aria-label="Velvet Terracotta atmosphere">
