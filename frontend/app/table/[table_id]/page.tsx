...
export default function TableHomePage({ params }: { params: { table_id: string } }) {
  ...
  const cardStyles = "relative flex flex-col items-center pmd-customer-card-sub backdrop-blur-sm rounded-3xl p-8 sm:p-12 shadow-sm hover:shadow-xl transition duration-500 w-72 h-56 justify-center surface-sub"
  const iconContainerStyles = "rounded-full pmd-customer-action-circle p-6 mb-6"
