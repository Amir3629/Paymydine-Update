          ...
          return (
            ...
            >
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full bg-[#062F2A] hover:bg-[#021F1C] text-white font-bold py-3 rounded-xl shadow-lg transition-colors duration-150"
              >
...
useEffect(() => {
  ...
  return (
        <MenuPageView contextLabel={isCashier ? "Cashier" : (displayTableNumber ? `Table ${displayTableNumber}` : "Delivery")} backHref={tableIdString ? `${buildTablePath(tableInfo, String(displayTableNumber || tableIdString))}${stickySearch()}` : "/"}>
