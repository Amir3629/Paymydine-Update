...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('app/admin/assets/css/pmd-waiter-v240-table-lifecycle.css') }}?v=240-20260716">
</head>
...
<script src="{{ asset('app/admin/assets/js/pmd-waiter-v240-table-lifecycle.js') }}?v=240-20260716"></script>
</body>
</html>
