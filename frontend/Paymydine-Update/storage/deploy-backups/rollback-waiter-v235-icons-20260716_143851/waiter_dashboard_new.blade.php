...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('app/admin/assets/css/pmd-waiter-v235-icon-system.css') }}?v=235-20260716">
</head>
...
<script src="{{ asset('app/admin/assets/js/pmd-waiter-v235-icon-system.js') }}?v=235-20260716"></script>
</body>
</html>
