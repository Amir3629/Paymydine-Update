(function () {
  ...
  function pmdV35FindLargestFinalFloor(frameDocument) {
    ...
    /*
     * V3.6:
     * The authoritative waiter floor is known exactly.
     * Do not guess by route, size, visibility or first match.
     */
    var exact =
    ...
    /*
     * Safe fallback for installations where one final
     * attribute was omitted, while still requiring real tables.
     */
  ...
  function pmdV33CopyWaiterFloorStyles(frameDocument) {
    /*
     * Copy relevant linked stylesheets.
     */
    Array.prototype.forEach.call(
      frameDocument.querySelectorAll(
      ...
      function (link) {
        ...
        if (
          !/waiter|floor|table-state|dashboard/i.test(href)
        ) {
          return;
        }
        ...
        copy.rel = 'stylesheet';
        copy.href = href;
        copy.dataset.pmdResV36FloorStyle = '1';
    ...
    /*
     * Most of the final V159/V160/V175/V180/V183/V190/V191
     * Floor authority CSS is inline in dashboardwaiter.
     * cloneNode() does not copy document-level <style> tags,
     * so copy only the style blocks that reference the Floor.
     */
    Array.prototype.forEach.call(
      frameDocument.querySelectorAll('style'),
      function (style, index) {
        var css = style.textContent || '';

        if (
          !/pmd-w5-floor|pmd-w5-table|pmd-v159|pmd-v160|pmd-v175|pmd-v180|pmd-v183|pmd-v190|pmd-v191/i.test(css)
        ) {
          return;
        }

        var id =
          'pmd-res-v36-inline-floor-style-' +
          index;
  ...
  function pmdV33MountWaiterFloor(
    ...
    console.info(
      '[PMD Reservations V3.6] Final dashboardwaiter floor mounted',
      {
        ...
        var timer = setInterval(
          function () {
            ...
            try {
              ...
              /*
               * dashboardwaiter may briefly render an older/partial map.
              ...
              /*
               * The dashboardwaiter floor is rendered progressively.
               * Wait until its table count remains unchanged for
               * several checks before cloning it.
               */
              /*
               * The correct Mimoza floor currently contains
               * tables 1 through 20. Wait until all twenty are
               * present and stable before cloning.
               */
              var numbers = map
                ? Array.prototype.map.call(
                    map.querySelectorAll(
              ...
              var expectedNumbers = Array.from(
                { length: 20 },
                function (_, index) {
              ...
              var hasExpectedTables =
                expectedNumbers.every(function (number) {
  ...
  async function install() {
    ...
    console.info(
      '[PMD] Reservation Layout V3.6 active',
      {
