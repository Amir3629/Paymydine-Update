...
<link rel="stylesheet" href="/app/admin/assets/css/pmd-waiter-pos-v286-dashboard-rebuild.css?v=286">
</head>
...
<script src="/app/admin/assets/js/pmd-waiter-pos-v286-dashboard-rebuild.js?v=286"></script>
</body></html>
@else
<!doctype html>
<html lang="en">
