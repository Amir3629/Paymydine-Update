...
(function () {
  try {
    if (
      localStorage.getItem(
        'pmd.admin.sidebar.collapsed.v1'
      ) === '1'
    ) {
      document.documentElement.classList.add(
        'pmd-sidebar-is-collapsed'
      );
    }
  }
  catch (_) {}
  ...
  document.documentElement.classList.add(
    'pmd-sidebar-preparing'
  );
})();
</script>
<link rel="stylesheet" href="/app/admin/assets/css/pmd-stable-sidebar-v1.css?v=1-20260717">
</head>
<script>
...
<script src="/app/admin/assets/js/pmd-stable-sidebar-v1.js?v=1-20260717"></script>
</body>
</html>
