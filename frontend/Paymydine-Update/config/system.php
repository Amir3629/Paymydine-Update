...
return [
    ...
    */
    ...
    |
    | Set to false to use direct asset files instead of combined assets.
    | This is recommended for production when you want to serve assets directly.
    |
    */

    'enableAssetCombiner' => env('ENABLE_ASSET_COMBINER', false),
