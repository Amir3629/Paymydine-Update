/* PayMyDine Owner/Admin Dashboard Clean v17
   Reference-style restaurant operations dashboard using the real v12 data model. */
(function () {
  'use strict';

  var VERSION = 'owner-clean-v17-final-reference-ops-20260626';
  var root = null;
  var lastData = null;
  ...
  function kitchenPerformance(data) {
    ...
    return '' +
      '<div class="pmd-v15-kitchen-metrics pmd-v17-kitchen-metrics">' +
      ...
      '</div>' +
      '<div class="pmd-v15-kitchen-metrics pmd-v17-kitchen-mini">' +
  ...
  function render(data) {
    ...
    root.innerHTML = '' +
      '<div class="pmd-v15-shell pmd-v17-shell">' +
        '<header class="pmd-v15-topbar pmd-v17-topbar">' +
        ...
        '<section class="pmd-v15-kpi-grid pmd-v17-kpi-grid">' +
        ...
        '<section class="pmd-v17-reference-grid">' +
          section('Live Restaurant Floor', 'Live · table coordinates + open-check status', floorPlan(s.floor_plan), 'pmd-v15-card--floor pmd-v17-area-floor', '<div class="pmd-v15-card-actions"><button type="button" data-pmd-owner-refresh>Refresh</button><a href="/admin/orders/create">New Order</a></div>') +
          section('Operations Alerts', 'Only owner-relevant connected issues', alerts(data), 'pmd-v15-card--alerts pmd-v17-area-alerts', '<a href="/admin/orders">View all</a>') +
          section('Recent Activity', 'Latest recorded orders and reservations', timeline(data), 'pmd-v15-card--timeline pmd-v17-area-timeline', '<a href="/admin/orders">View all</a>') +
        '</section>' +

        '<section class="pmd-v17-analytics-grid">' +
        ...
        '<section class="pmd-v17-bottom-grid">' +
  ...
  function staffOverview(staff) {
    ...
    if (servers.length) {
      ...
      return '<div class="pmd-v15-staff-total"><strong>' + esc(staff.total || 0) + '</strong><span>Team members detected</span></div>' +
        '<div class="pmd-v17-server-list">' + servers.map(function (x, idx) {
