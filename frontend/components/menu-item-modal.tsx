...
const handleModalClose = (event?: any) => {
 ...
 transition={{ duration: 0.48, ease: [0.22, 1, 0.36, 1] }}
	 className="relative surface pmd-customer-card rounded-3xl shadow-2xl w-full max-w-xl max-h-[90dvh] overflow-hidden"
 ...
 size="icon"
 onClick={handleModalClose}
	 className="inline-flex items-center justify-center absolute top-4 left-4 z-10 h-10 w-10 pmd-customer-action-circle shadow-lg hover:opacity-90"
>
 ...
 {/* Content */}
	 <h2 dir="auto" className="font-serif text-3xl font-bold pmd-customer-text mb-3 text-center">{itemName}</h2>
 ...
 />
	 ...
	 <p dir={getTextDirection(itemDescription)} className={`pmd-customer-muted-text text-lg leading-relaxed mb-4 ${getTextAlignClass(itemDescription)}`}>{itemDescription}</p>
