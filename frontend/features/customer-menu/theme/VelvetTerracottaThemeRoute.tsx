...
import { VelvetTerracottaBridgeTheme } from "@/components/themes/velvet-terracotta"
...
export function VelvetTerracottaThemeRoute(props: KazenThemeRouteProps) {
  const {
    apiMenuItems,
    menuItems,
    menuData,
  ...
  const velvetSrc =
    typeof window !== "undefined"
      ? `/themes/velvet-terracotta/?embedded=1&from=pmd&${window.location.search.replace(/^\?/, "")}`
      : "/themes/velvet-terracotta/?embedded=1&from=pmd"
    ...
    <ThemeActionBoundary actions={themeMenuActions}>
      ...
      >
        ...
        <PaymentModal
          ...
          checkoutVisualTheme="velvet_terracotta"
