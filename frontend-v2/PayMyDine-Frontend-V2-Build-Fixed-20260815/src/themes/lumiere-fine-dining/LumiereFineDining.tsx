...
import { Bell, Car, ChevronRight, Menu, Phone, Search, ShoppingBag, StickyNote } from 'lucide-react'
    ...
    <main className={styles.root} style={rootStyle} dir={direction} data-theme-id="lumiere_fine_dining">
      <div className={styles.frame}>
        ...
        <section className={styles.actions}>
          {bootstrap.features.callRestaurant && bootstrap.restaurant.phone && <a href={`tel:${bootstrap.restaurant.phone}`}><Phone /><span><small>{labels.callRestaurant}</small><strong>{bootstrap.restaurant.phone}</strong></span><ChevronRight /></a>}
