...
import { Bell, Menu, MessageCircle, Phone, Search, ShoppingCart, Sparkles, StickyNote, Zap } from 'lucide-react'
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroButtons}>
            {bootstrap.restaurant.phone && <a href={`tel:${bootstrap.restaurant.phone}`}><Phone />{labels.callRestaurant}</a>}
            {bootstrap.restaurant.whatsapp && <a href={`https://wa.me/${bootstrap.restaurant.whatsapp.replace(/\D/g,'')}`} target="_blank" rel="noreferrer"><MessageCircle />WhatsApp</a>}
          </div>
        </div>
