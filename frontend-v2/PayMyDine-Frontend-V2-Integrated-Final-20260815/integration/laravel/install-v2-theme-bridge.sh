...
p = Path(sys.argv[1])
s = p.read_text()
needle = "        require_once __DIR__.'/routes/theme-settings.php';"
insert = "        require_once __DIR__.'/routes/theme-settings.php';\n        require_once __DIR__.'/routes/pmd-frontend-v2-theme.php';"
...
echo "Verify: curl -sS https://mimoza.paymydine.com/api/v2/frontend-theme"
