...
export type ServiceMode = 'waiter' | 'valet'
...
export function MenuRuntimeProvider({ bootstrap, children }: { bootstrap: CustomerBootstrap; children: ReactNode }) {
  ...
  const value = useMemo<MenuRuntimeValue>(() => ({
    ...
    submitTableOrder, markOrderPaid, callWaiter, requestValet, requestStatus, toast, notify,
    ...
    removeCartLine, requestStatus, requestValet, search, selectedCategory, selectedItem, serviceMode,
