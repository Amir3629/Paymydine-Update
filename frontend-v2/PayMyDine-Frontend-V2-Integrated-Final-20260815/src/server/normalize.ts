...
function asset(value: unknown): string | null {
  ...
  // Only preserve paths for which V2 owns an explicit backend proxy route.
  // Bare public filenames from TastyIgniter (for example /logo.png) are routed
  // through /api/media so they also work on port 3002 / staging hostnames.
