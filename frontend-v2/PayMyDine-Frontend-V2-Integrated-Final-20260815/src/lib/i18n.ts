...
const en: UiLabels = {
  ...
  callWaiter: 'Call waiter', social: 'Social', cart: 'My order',
...
const de: UiLabels = {
  ...
  callWaiter: 'Kellner rufen', cart: 'Meine Bestellung',
...
const fa: UiLabels = {
  ...
  callWaiter: 'صدا کردن گارسون', cart: 'سفارش من', tableOrder: 'سفارش میز',
...
const tr: UiLabels = {
  ...
  callWaiter: 'Garson çağır', cart: 'Siparişim', tableOrder: 'Masa siparişi',
...
const ja: UiLabels = {
  ...
  callWaiter: 'スタッフを呼ぶ', cart: 'マイオーダー', tableOrder: 'テーブルオーダー',
