...
expect(component, 'setWaiterConfirmed(true)', 'waiter success is acknowledged only after authority resolves')
expect(component, 'waiterCalled: string', 'localized waiter confirmation copy contract')
expect(component, '{copy.waiterCalled}', 'waiter confirmation is visible inside the AI chat')
