...
expect(component, 'setInterval', 'staff-free visit reset polling')
...
expect(conversationStore, 'TTL_HOURS = 24', 'chat retention safety TTL')
expect(conversationStore, 'MAX_MESSAGES = 40', 'bounded saved chat')
