...
expect(component, 'response_locale', 'explicit response locale handshake')
...
expect(backendRoute, 'pmd_guest_ai_explicit_locale_20260902', 'explicit language request resolver')
expect(backendRoute, "'response_locale' => $responseLocale", 'response locale contract')
expect(backendRoute, 'answer only this menu request', 'request-scope response policy')
expect(backendRoute, 'Persian food', 'cuisine-vs-language regression note')
